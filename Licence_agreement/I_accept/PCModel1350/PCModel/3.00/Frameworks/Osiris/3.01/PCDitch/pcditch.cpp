...
// C++ main function
{
    ...
    else if (StrObject(argv[1]).getLCase().isInStr("p") && StrObject(argv[1]).isInStr("21316")) {void PCDitch21316Define(); return Analyser::main(PCDitch21316Define, argv[2]);}
    // call version 2.13.16 of pcditch and provide it with the analyser inputfilename
