...
"%compilerpath%\bin\g++" -o bin\pcditch.exe pcditch.o pcmodel.o pd21316c.o pd21316cd.o pd21316ci.o pd21316cc.o pd21316db.o -L./ -l bin\osiris -static-libgcc -static-libstdc++
del *.o
pause