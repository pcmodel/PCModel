...
_aInclStrat0_ =_IF_ ( _InclStrat_ _EQ_ _FALSE_ _OR_ _uDepthMix0_ _GT_ _cDepthWInit0_ - _cMinDepthHypEpi_ ) _THEN_ 0.0 _ELSE_ 1.0 _ENDIF_;
_sDepthW0_ = _IF_ (_InitDepth_ _EQ_ _TRUE_) _THEN_ _cDepthWInit0_ _ELSE_  _cDepthW0_ _ENDIF_ ;
_MassHyp0_ = _IF_ ( _CalcMass_ _EQ_ _TRUE_  _AND_ _aInclStrat0_ _EQ_ _TRUE_ ) _THEN_ _sDepthW0_ - _uDepthMix0_ _ELSE_ _cMinDepthHypEpi_ _ENDIF_ ;
...
_sDPisc0_ = _cDPisc0_;
_MassEpi0_ = _IF_ _CalcMass_ _EQ_ _TRUE_ _AND_ _sDepthW0_ _GE_ _uDepthMix0_ _THEN_ _uDepthMix0_ _ELSEIF_  _CalcMass_ _EQ_ _TRUE_ _THEN_ _sDepthW0_ _ELSE_ 1.0 _ENDIF_;
...
_uO2TotTHyp0_ = _IF_ (_aInclStrat0_ _EQ_ _TRUE_) _THEN_ (_sO2WHyp0_ ) * (_sDepthW0_ - _uDepthMix0_) / _MassHyp0_ _ELSE_ 0.0 _ENDIF_;
_uDTotTHyp0_ = _IF_ (_aInclStrat0_ _EQ_ _TRUE_) _THEN_ (_sDIMWHyp0_ + _sDDetWHyp0_ + _uDPhytWHyp0_ + _sDZooHyp0_) * (_sDepthW0_ - _uDepthMix0_) / _MassHyp0_ _ELSE_ 0.0 _ENDIF_;
_uPTotTHyp0_ = _IF_ (_aInclStrat0_ _EQ_ _TRUE_) _THEN_ (_sPO4WHyp0_ + _sPDetWHyp0_ + _sPAIMWHyp0_ + _uPPhytWHyp0_ + _sPZooHyp0_) * (_sDepthW0_ - _uDepthMix0_) / _MassHyp0_ _ELSE_ 0.0 _ENDIF_;
_uNTotTHyp0_ = _IF_ (_aInclStrat0_ _EQ_ _TRUE_) _THEN_ (_sNH4WHyp0_ + _sNO3WHyp0_ + _sNDetWHyp0_ + _uNPhytWHyp0_ + _sNZooHyp0_) * (_sDepthW0_ - _uDepthMix0_) / _MassHyp0_ _ELSE_ 0.0 _ENDIF_ ;
_uSiTotTHyp0_ = _IF_ (_aInclStrat0_ _EQ_ _TRUE_) _THEN_ (_sSiO2WHyp0_ + _sSiDetWHyp0_ + _cSiDDiat_ * _sDDiatWHyp0_) * (_sDepthW0_ - _uDepthMix0_) / _MassHyp0_ _ELSE_ 0.0 _ENDIF_;
...
_uO2TotT0_ = _IF_  _sDepthW0_ _GE_ _uDepthMix0_ _THEN_ _uO2TotTHyp0_ + ( _sO2WEpi0_) * _uDepthMix0_ / _MassEpi0_ + _uO2TotM0_  _ELSE_ ( _sO2WEpi0_) *_sDepthW0_ / _MassEpi0_ + _uO2TotM0_  _ENDIF_ ;
_uDTotT0_ = _IF_  _sDepthW0_ _GE_ _uDepthMix0_ _THEN_ _uDTotTHyp0_ + (_sDIMWEpi0_ + _sDDetWEpi0_ + _uDPhytWEpi0_ + _sDZooEpi0_) * _uDepthMix0_ / _MassEpi0_ + _uDVeg0_ + _sDIMS0_ + _sDHumS0_ + _sDDetS0_ + _uDPhytS0_ + _uDFish0_ + _sDPisc0_ + _sDBent0_ + _uDTotM0_  _ELSE_ (_sDIMWEpi0_ + _sDDetWEpi0_ + _uDPhytWEpi0_ + _sDZooEpi0_) * _sDepthW0_ / _MassEpi0_ + _uDVeg0_ + _sDIMS0_ + _sDHumS0_ + _sDDetS0_ + _uDPhytS0_ + _uDFish0_ + _sDPisc0_ + _sDBent0_ + _uDTotM0_ _ENDIF_ ;
_uPTotT0_ = _IF_  _sDepthW0_ _GE_ _uDepthMix0_ _THEN_ _uPTotTHyp0_ + (_sPO4WEpi0_ + _sPDetWEpi0_ + _sPAIMWEpi0_ + _uPPhytWEpi0_ + _sPZooEpi0_) * _uDepthMix0_ / _MassEpi0_+ _uPVeg0_ + _sPO4S0_ + _sPDetS0_ + _sPAIMS0_ + _sPHumS0_ + _uPPhytS0_ + _uPFish0_ + _uPPisc0_ + _sPBent0_ + _uPTotM0_  _ELSE_ + (_sPO4WEpi0_ + _sPDetWEpi0_ + _sPAIMWEpi0_ + _uPPhytWEpi0_ + _sPZooEpi0_) * _sDepthW0_ / _MassEpi0_+ _uPVeg0_ + _sPO4S0_ + _sPDetS0_ + _sPAIMS0_ + _sPHumS0_ + _uPPhytS0_ + _uPFish0_ + _uPPisc0_ + _sPBent0_ + _uPTotM0_  _ENDIF_  ;
_uNTotT0_ =  _IF_  _sDepthW0_ _GE_ _uDepthMix0_ _THEN_  _uNTotTHyp0_ + (_sNH4WEpi0_ + _sNO3WEpi0_ + _sNDetWEpi0_ + _uNPhytWEpi0_ + _sNZooEpi0_) * _uDepthMix0_ / _MassEpi0_ + _uNVeg0_ + _sNH4S0_ + _sNO3S0_ + _sNDetS0_ + _uNPhytS0_ + _sNHumS0_ + _uNFish0_ + _uNPisc0_ + _sNBent0_ + _uNTotM0_  _ELSE_   (_sNH4WEpi0_ + _sNO3WEpi0_ + _sNDetWEpi0_ + _uNPhytWEpi0_ + _sNZooEpi0_) * _sDepthW0_ / _MassEpi0_ + _uNVeg0_ + _sNH4S0_ + _sNO3S0_ + _sNDetS0_ + _uNPhytS0_ + _sNHumS0_ + _uNFish0_ + _uNPisc0_ + _sNBent0_ + _uNTotM0_  _ENDIF_;
_uSiTotT0_ = _IF_  _sDepthW0_ _GE_ _uDepthMix0_ _THEN_ _uSiTotTHyp0_+ (_sSiO2WEpi0_ + _sSiDetWEpi0_ + _cSiDDiat_ * _sDDiatWEpi0_) * _uDepthMix0_ / _MassEpi0_ + _sSiDetS0_ + _cSiDDiat_*_sDDiatS0_ + _uSiTotM0_  _ELSE_ (_sSiO2WEpi0_ + _sSiDetWEpi0_ + _cSiDDiat_ * _sDDiatWEpi0_) * _sDepthW0_ / _MassEpi0_ + _sSiDetS0_ + _cSiDDiat_*_sDDiatS0_ + _uSiTotM0_  _ENDIF_ ;
