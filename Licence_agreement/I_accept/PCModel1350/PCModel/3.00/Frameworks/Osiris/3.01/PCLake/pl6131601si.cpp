...
_aInclStrat0_ =_IF_ ( _InclStrat_ _EQ_ _FALSE_ _OR_ _uDepthMix0_ _GT_ _cDepthW0_ - _cMinDepthHyp_ ) _THEN_ 0.0 _ELSE_ 1.0 _ENDIF_;
_sDepthWHyp0_ = _IF_ ( _InclStrat_ _EQ_ _FALSE_) _THEN_ 9999 _ELSEIF_ (_InitDepth_ _EQ_ _TRUE_ _AND_ (_uDepthMix0_ _LE_ _cDepthW0_ -_cMinDepthHyp_ ) ) _THEN_ _cDepthW0_ - _uDepthMix0_ _ELSEIF_ (_InitDepth_ _EQ_ _TRUE_ _AND_ ( _uDepthMix0_ _GT_ _cDepthW0_ - _cMinDepthHyp_ )) _THEN_ 9999 _ELSE_ _cDepthWHyp0_ _ENDIF_;
...
_sDPisc0_ = _cDPisc0_;
_sDepthWEpi0_ = _IF_ ( _aInclStrat0_ _EQ_ _FALSE_) _THEN_ _cDepthW0_ _ELSEIF_ (_InitDepth_ _EQ_ _TRUE_ _AND_ ( _uDepthMix0_ _LE_ _cDepthW0_ - _cMinDepthHyp_)) _THEN_ _uDepthMix0_ _ELSEIF_ (_InitDepth_ _EQ_ _TRUE_ _AND_( _uDepthMix0_ _GT_ _cDepthW0_ - _cMinDepthHyp_ )) _THEN_ _cDepthW0_ _ELSE_ _cDepthWEpi0_ _ENDIF_;
...
_uDTotT0_ = _uDTotTHyp0_ + (_sDIMWEpi0_ + _sDDetWEpi0_ + _uDPhytWEpi0_ + _sDZooEpi0_) * _sDepthWEpi0_ / _MassEpi0_ + _uDVeg0_ + _sDIMS0_ + _sDHumS0_ + _sDDetS0_ + _uDPhytS0_ + _uDFish0_ + _sDPisc0_ + _sDBent0_ + _uDTotM0_;
_uPTotT0_ = _uPTotTHyp0_ + (_sPO4WEpi0_ + _sPDetWEpi0_ + _sPAIMWEpi0_ + _uPPhytWEpi0_ + _sPZooEpi0_) * _sDepthWEpi0_ / _MassEpi0_+ _uPVeg0_ + _sPO4S0_ + _sPDetS0_ + _sPAIMS0_ + _sPHumS0_ + _uPPhytS0_ + _uPFish0_ + _uPPisc0_ + _sPBent0_ + _uPTotM0_;
_uNTotT0_ = _uNTotTHyp0_ + (_sNH4WEpi0_ + _sNO3WEpi0_ + _sNDetWEpi0_ + _uNPhytWEpi0_ + _sNZooEpi0_) * _sDepthWEpi0_ / _MassEpi0_ + _uNVeg0_ + _sNH4S0_ + _sNO3S0_ + _sNDetS0_ + _uNPhytS0_ + _sNHumS0_ + _uNFish0_ + _uNPisc0_ + _sNBent0_ + _uNTotM0_;
