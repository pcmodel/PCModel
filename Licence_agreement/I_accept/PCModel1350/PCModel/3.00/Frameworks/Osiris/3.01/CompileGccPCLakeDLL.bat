...
"%compilerpath%\bin\g++" -o bin\pclake.exe pclake.o pcmodel.o pl61316c.o pl61316cd.o pl61316ci.o pl61316cc.o pl61316db.o -L./ -l bin\osiris -static-libgcc -static-libstdc++
del *.o
pause