...
_aInclStrat_ =_IF_ ( _InclStrat_ _EQ_ _FALSE_ _OR_ _uDepthMix_ _GT_ _cDepthW0_ - _cMinDepthHyp_ ) _THEN_ 0.0 _ELSE_ 1.0 _ENDIF_;
...
_uVegHeightLightHyp_ = _IF_ (  _uVegHeightLight_ _GT_ _uVegHeightEpi_ ) _THEN_ _uVegHeightLight_ - _uVegHeightLightEpi_  _ELSE_ _uVegHeightLight_ _ENDIF_;
...
_aLPARBotEpiOpen_ = _uLPARSurf_ * _EXP_(- _aExtCoefOpenEpi_ * _sDepthWEpi_);
_aLPARBotHypOpen_ = _aLPARBotEpiOpen_ * _EXP_(- _aExtCoefOpenHyp_ * _sDepthWEpi_);
_aLPAR1VegEpi_ = _uLPARSurf_ * _EXP_(- _aExtCoefOpenEpi_ * _aDepth1VegEpi_) * ( 1 - _uVegShade_ );
...
_uDayWinVeg_ = _IF_ _UseLWinVeg_ _LE_ _NearZero_ _THEN_ _cDayWinVeg_ _ELSEIF_ (_Day_ _LT_ 1.0 _OR_ _sTime_ _LT_ _BeginTime_ + 1.0) _THEN_ 367 _ELSEIF_ (_aLPIVeg_ _LE_ _cLAlloVeg_ _AND_ _uDayWinVeg_ _GT_ 366 _AND_ _Day_ _GT_ 183 ) _THEN_ _Day_ _ELSE_ _uDayWinVeg_ _ENDIF_;
...
_aLPARBotEpi_ = _uLPARSurf_ * _EXP_(- _aExtCoefEpi_ * _sDepthWEpi_);
...
_vTranHypEpiW_ = _IF_ ( _aStrat_ _EQ_ _TRUE_ _AND_ _uDepthMix_ _LE_ _sDepthWEpi_ ) _THEN_ 0.0 _ELSE_ ( _uDepthMix_ -_sDepthWEpi_ ) * _kExchW_ _ENDIF_;
...
_akExchWHyp_= _IF_ (_aInclStrat_ _EQ_ _TRUE_ _AND_ _sDepthWHyp_ _GT_ _NearZero_) _THEN_ ( _uExchMaxW_  + _vTranHypEpiW_ ) / _sDepthWHyp_ _ELSE_ 0.0 _ENDIF_;
...
_wNUptNH4BlueHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _afNH4UptBlueHyp_ * _wNUptBlueHyp_ _ENDIF_;
_wNUptNO3BlueHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wNUptBlueHyp_ - _wNUptNH4BlueHyp_ _ENDIF_;
...
_tDSetBlueHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _uCorVSetBlueHyp_ * _oDBlueWHyp_ _ENDIF_;
...
_tDSetBlueEpi_ = _uCorVSetBlueEpi_ * _oDBlueWEpi_;
...
_wDPrimBlueWHyp_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wDAssBlueHyp_ - _wDRespBlueWHyp_ - _wDLossBlueHyp_ - _wDMortBlueWHyp_ -(_tDSetBlueHyp_ - _tDSetBlueEpi_ - _tDResusBlue_) / _sDepthWHyp_ _ENDIF_;
_wPPrimBlueWHyp_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wPUptBlueHyp_ - _wPExcrBlueWHyp_ - _wPLossBlueHyp_ - _wPMortBlueWHyp_ -(_tPSetBlueHyp_ - _tPSetBlueEpi_ - _tPResusBlue_) / _sDepthWHyp_ _ENDIF_;
_wNPrimBlueWHyp_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wNUptBlueHyp_ - _wNExcrBlueWHyp_ - _wNLossBlueHyp_ - _wNMortBlueWHyp_ -(_tNSetBlueHyp_ - _tNSetBlueEpi_ - _tNResusBlue_) / _sDepthWHyp_ _ENDIF_;
...
_akExchMEpi_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _kExchMaxM_ * _hfMarsh_ /(_hfMarsh_ + _fMarsh_) + _vTranDepthW_ / _sDepthWM_ _ELSE_ 0.0 _ENDIF_;
...
_tO2AerEpi_ = _kAer_ * _uFunTmAerEpi_ * (_uO2SatEpi_ - _oO2WEpi_) * _aFunLemnAer_;
...
_wNUptNH4BlueEpi_ = _afNH4UptBlueEpi_ * _wNUptBlueEpi_;
_wNUptNO3BlueEpi_ = _wNUptBlueEpi_ - _wNUptNH4BlueEpi_;
...
_aLLimBlueEpi_ = _UseSteeleBlue_ *(_EXP_(1.0) /(_aExtCoefEpi_ * _sDepthWEpi_) *(_EXP_(- _aLPARBotEpi_ /(_cLOptRefBlue_ * _uFunTmProdBlueEpi_)) - _EXP_(- _uLPARSurf_ /(_cLOptRefBlue_ * _uFunTmProdBlueEpi_)))) +(1.0 - _UseSteeleBlue_) *(1.0 /(_aExtCoefEpi_ * _sDepthWEpi_) * _LN_((1.0 + _uLPARSurf_ / (_hLRefBlue_ * _uFunTmProdBlueEpi_)) / (1.0 + _aLPARBotEpi_ /(_hLRefBlue_ * _uFunTmProdBlueEpi_))));
...
_wDPrimBlueWEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wDAssBlueEpi_ - _wDRespBlueWEpi_ - _wDLossBlueEpi_ - _wDMortBlueWEpi_ -(_tDSetBlueEpi_ ) / _sDepthWEpi_ _ELSE_ _wDAssBlueEpi_ - _wDRespBlueWEpi_ - _wDLossBlueEpi_ - _wDMortBlueWEpi_ -(_tDSetBlueEpi_ - _tDResusBlue_) / _sDepthWEpi_ _ENDIF_;
_wPPrimBlueWEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wPUptBlueEpi_ - _wPExcrBlueWEpi_ - _wPLossBlueEpi_ - _wPMortBlueWEpi_ -(_tPSetBlueEpi_ ) / _sDepthWEpi_ _ELSE_ _wPUptBlueEpi_ - _wPExcrBlueWEpi_ - _wPLossBlueEpi_ - _wPMortBlueWEpi_ -(_tPSetBlueEpi_ - _tPResusBlue_) / _sDepthWEpi_ _ENDIF_;
_wNPrimBlueWEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wNUptBlueEpi_ - _wNExcrBlueWEpi_ - _wNLossBlueEpi_ - _wNMortBlueWEpi_ -(_tNSetBlueEpi_ ) / _sDepthWEpi_ _ELSE_ _wNUptBlueEpi_ - _wNExcrBlueWEpi_ - _wNLossBlueEpi_ - _wNMortBlueWEpi_ -(_tNSetBlueEpi_ - _tNResusBlue_) / _sDepthWEpi_ _ENDIF_;
...
_aLLimGrenEpi_ = _UseSteeleGren_ *(_EXP_(1.0) /(_aExtCoefEpi_ * _sDepthWEpi_) *(_EXP_(- _aLPARBotEpi_ /(_cLOptRefGren_ * _uFunTmProdGrenEpi_)) - _EXP_(- _uLPARSurf_ /(_cLOptRefGren_ * _uFunTmProdGrenEpi_)))) +(1.0 - _UseSteeleGren_) *(1.0 /(_aExtCoefEpi_ * _sDepthWEpi_) * _LN_((1.0 + _uLPARSurf_ / (_hLRefGren_ * _uFunTmProdGrenEpi_)) / (1.0 + _aLPARBotEpi_ /(_hLRefGren_ * _uFunTmProdGrenEpi_))));
...
_aLLimDiatEpi_ = _UseSteeleDiat_ *(_EXP_(1.0) /(_aExtCoefEpi_ * _sDepthWEpi_) *(_EXP_(- _aLPARBotEpi_ /(_cLOptRefDiat_ * _uFunTmProdDiatEpi_)) - _EXP_(- _uLPARSurf_ /(_cLOptRefDiat_ * _uFunTmProdDiatEpi_)))) +(1.0 - _UseSteeleDiat_) *(1.0 /(_aExtCoefEpi_ * _sDepthWEpi_) * _LN_((1.0 + _uLPARSurf_ / (_hLRefDiat_ * _uFunTmProdDiatEpi_)) / (1.0 + _aLPARBotEpi_ /(_hLRefDiat_ * _uFunTmProdDiatEpi_))));
...
_oChla_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ (_oChlaEpi_ * _sDepthWEpi_ + _oChlaHyp_ * _sDepthWHyp_ ) / _uDepthW_ _ELSE_ _oChlaEpi_ _ENDIF_;
_aLPIEpi_ =  (_uLPARSurf_- _aLPARBotEpiOpen_ + _uhLVeg_* _LN_((1.0 +_aLPARBotEpiOpen_/ _uhLVeg_)  /(1.0 + _uLPARSurf_  / _uhLVeg_) + _NearZero_  ) ) / _sDepthWEpi_;
_aLMeasEpi_ = _uLPARSurf_ * _EXP_(- _aExtCoefOpenEpi_ *_cDepthMeasoChl_);
...
_wDLossPhytEpi_ = _wDLossDiatEpi_ + _wDLossGrenEpi_ + _wDLossBlueEpi_;
...
_wPLossPhytEpi_ = _wPLossDiatEpi_ + _wPLossGrenEpi_ + _wPLossBlueEpi_;
...
_wNLossPhytEpi_ = _wNLossDiatEpi_ + _wNLossGrenEpi_ + _wNLossBlueEpi_;
...
_wDPrimDetWEpi_ = _wDMortPhytWEpi_ + _wDLossPhytEpi_;
_tDPrimDetS_ = _tDMortPhytS_;
_tDPrimTotT_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_ ) _THEN_(_wDAssPhytEpi_ - _wDRespPhytWEpi_) * _sDepthWEpi_ - _tDRespPhytS_ _ELSE_ (_wDAssPhytEpi_ - _wDRespPhytWEpi_) * _sDepthWEpi_ + (_wDAssPhytHyp_ - _wDRespPhytWHyp_) * _sDepthWHyp_ - _tDRespPhytS_ _ENDIF_;
...
_wPMortPhytDetWEpi_ = _wPMortPhytWEpi_ - _wPMortPhytPO4WEpi_;
_wPLossPhytPO4Epi_ = _fDissLoss_ * _wPLossPhytEpi_;
_wPLossPhytDetEpi_ = _wPLossPhytEpi_ - _wPLossPhytPO4Epi_;
_wPPrimPO4WEpi_ = - _wPUptPhytEpi_ + _wPExcrPhytWEpi_ + _wPLossPhytPO4Epi_ + _wPMortPhytPO4WEpi_;
...
_wNMortPhytDetWEpi_ = _wNMortPhytWEpi_ - _wNMortPhytNH4WEpi_;
_wNLossPhytNH4Epi_ = _fDissLoss_ * _wNLossPhytEpi_;
_wNLossPhytDetEpi_ = _wNLossPhytEpi_ - _wNLossPhytNH4Epi_;
_wNPrimNH4WEpi_ = - _wNUptNH4PhytEpi_ + _wNExcrPhytWEpi_ + _wNLossPhytNH4Epi_ + _wNMortPhytNH4WEpi_;
_wNPrimNO3WEpi_ = - _wNUptNO3PhytEpi_;
...
_oDFoodZooEpi_ = _cPrefDiat_ * _oDDiatWEpi_ + _cPrefGren_ * _oDGrenWEpi_ + _cPrefBlue_ * _oDBlueWEpi_ + _cPrefDet_ * _oDDetWEpi_;
...
_wDConsPhytZooEpi_ = _wDConsDiatZooEpi_ + _wDConsGrenZooEpi_ + _wDConsBlueZooEpi_;
...
_oPFoodZooEpi_ = _cPrefDiat_*_oPDiatWEpi_ + _cPrefGren_*_oPGrenWEpi_ + _cPrefBlue_*_oPBlueWEpi_ + _cPrefDet_ * _oPDetWEpi_;
...
_wPConsPhytZooEpi_ = _wPConsDiatZooEpi_ + _wPConsGrenZooEpi_ + _wPConsBlueZooEpi_;
...
_oNFoodZooEpi_ = _cPrefDiat_*_oNDiatWEpi_ + _cPrefGren_*_oNGrenWEpi_ + _cPrefBlue_*_oNBlueWEpi_ + _cPrefDet_*_oNDetWEpi_;
...
_wNConsPhytZooEpi_ = _wNConsDiatZooEpi_ + _wNConsGrenZooEpi_ + _wNConsBlueZooEpi_;
...
_aDTotT_ = _aDTotTHyp_ + (_oDIMWEpi_+_oDDetWEpi_+_oDDiatWEpi_+_oDGrenWEpi_+_oDBlueWEpi_+_oDZooEpi_) * _sDepthWEpi_ +_aDFish_+_sDPisc_+_aDVeg_ +_sDIMS_+_sDHumS_+_sDDetS_+_sDDiatS_+_sDGrenS_+_sDBlueS_+_sDBent_ + _aDTotM_;
_aNTotT_ = _aNTotTHyp_+ (_oNH4WEpi_+_oNO3WEpi_+_oNDetWEpi_+_oNDiatWEpi_+_oNGrenWEpi_+_oNBlueWEpi_ +_oNZooEpi_)*_sDepthWEpi_ +_aNFish_+_aNPisc_+_aNVeg_ +_sNH4S_+_sNO3S_+_sNDetS_+_sNHumS_+_sNDiatS_+_sNGrenS_+_sNBlueS_ +_sNBent_ + _aNTotM_;
_aPTotT_ = _aPTotTHyp_ + (_oPO4WEpi_+_oPDetWEpi_+_oPDiatWEpi_+_oPGrenWEpi_+_oPBlueWEpi_ +_oPZooEpi_+_oPAIMWEpi_) * _sDepthWEpi_ +_aPFish_+_aPPisc_+_aPVeg_ +_sPO4S_+_sPDetS_+_sPHumS_+_sPDiatS_+_sPGrenS_+_sPBlueS_ +_sPAIMS_+_sPBent_ + _aPTotM_;
