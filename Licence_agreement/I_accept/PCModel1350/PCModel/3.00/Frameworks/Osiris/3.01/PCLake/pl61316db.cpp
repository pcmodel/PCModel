...
{
#include "../pclake/pl61316rp_.cpp" // declare parameters
#include "../pclake/pl61316rc_.cpp" // declare initial states
#include "../pclake/pl61316ri_.cpp" // declare initial auxiliaries
#include "../pclake/pl61316rs_.cpp" // declare states
#include "../pclake/pl61316ra_.cpp" // declare auxiliaries
#include "../pclake/pl61316rd_.cpp" // declare derivatives
#include "../pclake/pl61316sp.cpp" // set parameters
#include "../pclake/pl61316sc.cpp" // set initial states
#include "../pclake/pl61316si.cpp" // set initial auxiliaries
#include "../pclake/pl61316ss.cpp" // set states
#include "../pclake/pl61316sa.cpp" // set auxiliaries
#include "../pclake/pl61316sd.cpp" // set derivatives
#include "../pclake/pl61316rdd.cpp" // set derivatives
}
...
#include "../pclake/pl61316sp.cpp" // set parameters
#include "../pclake/pl61316sc.cpp" // set initial states
#include "../pclake/pl6131600si.cpp" // set initial auxiliaries
#include "../pclake/pl6131600ss.cpp" // set states
...
#include "../pclake/pl61316sp.cpp" // set parameters
#include "../pclake/pl61316sc.cpp" // set initial states
#include "../pclake/pl6131601si.cpp" // set initial auxiliaries
#include "../pclake/pl6131601ss.cpp" // set states
...
#include "../pclake/pl61316sp.cpp" // set parameters
#include "../pclake/pl61316sc.cpp" // set initial states
#include "../pclake/pl6131602si.cpp" // set initial auxiliaries
#include "../pclake/pl6131602ss.cpp" // set states
...
#include "../pclake/pl61316sp.cpp" // set parameters
#include "../pclake/pl61316sc.cpp" // set initial states
#include "../pclake/pl6131603si.cpp" // set initial auxiliaries
#include "../pclake/pl6131603ss.cpp" // set states
