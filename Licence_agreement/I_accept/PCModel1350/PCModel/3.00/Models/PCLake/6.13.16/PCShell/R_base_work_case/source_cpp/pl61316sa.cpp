...
_MassHyp_ = _IF_ _CalcMass_ _EQ_ _TRUE_ _THEN_ _sDepthWHyp_ _ELSE_ 1.0 _ENDIF_;
_MassEpi_ = _IF_ _CalcMass_ _EQ_ _TRUE_ _THEN_ _sDepthWEpi_ _ELSE_ 1.0 _ENDIF_;
_MassWM_ = _IF_ _CalcMass_ _EQ_ _TRUE_ _THEN_ _sDepthWM_ _ELSE_ 1.0 _ENDIF_;
_oNH4WHyp_ = _sNH4WHyp_ / _MassHyp_;
_oNO3WHyp_ = _sNO3WHyp_ / _MassHyp_;
_oPO4WHyp_ = _sPO4WHyp_ / _MassHyp_;
_oPAIMWHyp_ = _sPAIMWHyp_ / _MassHyp_;
_oSiO2WHyp_ = _sSiO2WHyp_ / _MassHyp_;
_oO2WHyp_ = _sO2WHyp_ / _MassHyp_;
_oDDetWHyp_ = _sDDetWHyp_ / _MassHyp_;
_oNDetWHyp_ = _sNDetWHyp_ / _MassHyp_;
_oPDetWHyp_ = _sPDetWHyp_ / _MassHyp_;
_oSiDetWHyp_ = _sSiDetWHyp_ / _MassHyp_;
_oDIMWHyp_ = _sDIMWHyp_ / _MassHyp_;
_oDDiatWHyp_ = _sDDiatWHyp_ / _MassHyp_;
_oNDiatWHyp_ = _sNDiatWHyp_ / _MassHyp_;
_oPDiatWHyp_ = _sPDiatWHyp_ / _MassHyp_;
_oDGrenWHyp_ = _sDGrenWHyp_ / _MassHyp_;
_oNGrenWHyp_ = _sNGrenWHyp_ / _MassHyp_;
_oPGrenWHyp_ = _sPGrenWHyp_ / _MassHyp_;
_oDBlueWHyp_ = _sDBlueWHyp_ / _MassHyp_;
_oNBlueWHyp_ = _sNBlueWHyp_ / _MassHyp_;
_oPBlueWHyp_ = _sPBlueWHyp_ / _MassHyp_;
_oDZooHyp_ = _sDZooHyp_ / _MassHyp_;
_oNZooHyp_ = _sNZooHyp_ / _MassHyp_;
_oPZooHyp_ = _sPZooHyp_ / _MassHyp_;
_oNH4WM_ = _sNH4WM_ / _MassWM_;
_oNO3WM_ = _sNO3WM_ / _MassWM_;
_oPO4WM_ = _sPO4WM_ / _MassWM_;
_oPAIMWM_ = _sPAIMWM_ / _MassWM_;
_oSiO2WM_ = _sSiO2WM_ / _MassWM_;
_oO2WM_ = _sO2WM_ / _MassWM_;
_oDDetWM_ = _sDDetWM_ / _MassWM_;
_oNDetWM_ = _sNDetWM_ / _MassWM_;
_oPDetWM_ = _sPDetWM_ / _MassWM_;
_oSiDetWM_ = _sSiDetWM_ / _MassWM_;
_oDIMWM_ = _sDIMWM_ / _MassWM_;
_oDDiatWM_ = _sDDiatWM_ / _MassWM_;
_oNDiatWM_ = _sNDiatWM_ / _MassWM_;
_oPDiatWM_ = _sPDiatWM_ / _MassWM_;
_oDGrenWM_ = _sDGrenWM_ / _MassWM_;
_oNGrenWM_ = _sNGrenWM_ / _MassWM_;
_oPGrenWM_ = _sPGrenWM_ / _MassWM_;
_oDBlueWM_ = _sDBlueWM_ / _MassWM_;
_oNBlueWM_ = _sNBlueWM_ / _MassWM_;
_oPBlueWM_ = _sPBlueWM_ / _MassWM_;
_oDZooM_ = _sDZooM_ / _MassWM_;
_oNZooM_ = _sNZooM_ / _MassWM_;
_oPZooM_ = _sPZooM_ / _MassWM_;
_oNH4WEpi_ = _sNH4WEpi_ / _MassEpi_;
_oNO3WEpi_ = _sNO3WEpi_ / _MassEpi_;
_oPO4WEpi_ = _sPO4WEpi_ / _MassEpi_;
_oPAIMWEpi_ = _sPAIMWEpi_ / _MassEpi_;
_oSiO2WEpi_ = _sSiO2WEpi_ / _MassEpi_;
_oO2WEpi_ = _sO2WEpi_ / _MassEpi_;
_oDDetWEpi_ = _sDDetWEpi_ / _MassEpi_;
_oNDetWEpi_ = _sNDetWEpi_ / _MassEpi_;
_oPDetWEpi_ = _sPDetWEpi_ / _MassEpi_;
_oSiDetWEpi_ = _sSiDetWEpi_ / _MassEpi_;
_oDIMWEpi_ = _sDIMWEpi_ / _MassEpi_;
_oDDiatWEpi_ = _sDDiatWEpi_ / _MassEpi_;
_oNDiatWEpi_ = _sNDiatWEpi_ / _MassEpi_;
_oPDiatWEpi_ = _sPDiatWEpi_ / _MassEpi_;
_oDGrenWEpi_ = _sDGrenWEpi_ / _MassEpi_;
_oNGrenWEpi_ = _sNGrenWEpi_ / _MassEpi_;
_oPGrenWEpi_ = _sPGrenWEpi_ / _MassEpi_;
_oDBlueWEpi_ = _sDBlueWEpi_ / _MassEpi_;
_oNBlueWEpi_ = _sNBlueWEpi_ / _MassEpi_;
_oPBlueWEpi_ = _sPBlueWEpi_ / _MassEpi_;
_oDZooEpi_ = _sDZooEpi_ / _MassEpi_;
_oNZooEpi_ = _sNZooEpi_ / _MassEpi_;
_oPZooEpi_ = _sPZooEpi_ / _MassEpi_;
_TimeYears_ = _sTime_ / _DaysPerYear_;
_Day_ = _sTime_ - _FLOOR_(_TimeYears_) * _DaysPerYear_;
_Years_ = _YearZero_ + _TimeYears_;
_uDepthMix_ =_IF_ ( _calcMixDepth_ _EQ_ _TRUE_ ) _THEN_ _cAMix_ * _POW_ ( _cFetch_ , (_cBMix_) ) _ELSE_ _cDepthMix_ _ENDIF_;
_aInclStrat_ =_IF_ ( _InclStrat_ _EQ_ _FALSE_ ) _THEN_ 0.0 _ELSE_ 1.0 _ENDIF_;
_uDepthW_ =_IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _sDepthWHyp_ + _sDepthWEpi_ _ELSE_ _sDepthWEpi_ _ENDIF_;
_uVegHeight_ = _IF_ ( _cVegHeight_ _LT_ _uDepthW_ ) _THEN_ _cVegHeight_ _ELSE_ _uDepthW_ _ENDIF_;
_uVegHeightHyp_ = _IF_ ( _aInclStrat_ _EQ_ _FALSE_ ) _THEN_ 0.0 _ELSEIF_ (_uVegHeight_ _GT_ _sDepthWHyp_ ) _THEN_ _sDepthWHyp_ _ELSE_ _uVegHeight_ _ENDIF_;
_uVegHeightEpi_ = _IF_ ( _aInclStrat_ _EQ_ _FALSE_ _AND_ _uVegHeight_ _LT_ _sDepthWEpi_ ) _THEN_ _uVegHeight_ _ELSEIF_ ( _aInclStrat_ _EQ_ _FALSE_ _AND_ _uVegHeight_ _GE_ _sDepthWEpi_ ) _THEN_ _sDepthWEpi_ _ELSEIF_ (_uVegHeight_ _GT_ _sDepthWHyp_ ) _THEN_ _uVegHeight_ -_sDepthWHyp_ _ELSE_ 0.0 _ENDIF_;
...
_uDVegHyp_ = _uVegHeightHyp_ / _uVegHeight_ * _sDVeg_;
_uDVegEpi_ = _uVegHeightEpi_ / _uVegHeight_ * _sDVeg_;
...
_uSunRise_ = _IF_(_InclLat_ _EQ_ _TRUE_) _THEN_ _HoursInDay_/(2*_Pi_)*_ACOS_((_SIN_(_uLAT_)*_SIN_(_uSolDecAng_))/(_COS_(_uLAT_)*_COS_(_uSolDecAng_))) _ELSE_ 0.0 _ENDIF_;
...
_aDepth2VegHyp_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _sDepthWHyp_ _ELSE_ 0.0 _ENDIF_;
_aDepth1VegHyp_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _sDepthWHyp_ - _uVegHeightHyp_ _ELSE_ 0.0 _ENDIF_;
_aDepth1VegEpi_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _sDepthWEpi_ - _uVegHeightEpi_ _ELSE_ _fDepth1Veg_ * _uDepthW_ _ENDIF_;
_aDepth2VegEpi_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _sDepthWEpi_ _ELSE_ _fDepth2Veg_ * _uDepthW_ _ENDIF_;
_aDayInitVeg_ = _IF_ (_Day_ _LT_ 1.0 _OR_ _sTime_ _LT_ _BeginTime_ + 1.0) _THEN_ 367 _ELSEIF_ (_uTmBot_ _GE_ _cTmInitVeg_ _AND_ _aDayInitVeg_ _GT_ 366) _THEN_ _Day_ _ELSE_ _aDayInitVeg_ _ENDIF_;
_aLPARBotSurf_ = _IF_ (_InclSurf_ _EQ_ _TRUE_) _THEN_ _uLPARSurf_ * _EXP_(- _aExtSurf_) _ELSE_ _uLPARSurf_ _ENDIF_;
_aLPARBotEpiOpen_ = _aLPARBotSurf_ * _EXP_(- _aExtCoefOpenEpi_ * _sDepthWEpi_);
_aLPARBotHypOpen_ = _aLPARBotEpiOpen_ * _EXP_(- _aExtCoefOpenHyp_ * _sDepthWEpi_);
...
_aLPARVegLight_ =  _IF_  ( _aInclStrat_ _EQ_ _TRUE_ _AND_  _uVegHeight_ _LE_ _sDepthWHyp_ ) _THEN_ _aLPAR1VegHyp_ *   _EXP_(- _aExtCoefOpenHyp_ * _uVegHeightLightEpi_) _ELSE_ _aLPAR1VegEpi_ *  _EXP_(- _aExtCoefOpenEpi_ * _uVegHeightLightEpi_)  *  _EXP_(- _aExtCoefOpenHyp_ * _uVegHeightLightEpi_) _ENDIF_;
...
_uFunTmProdVeg_ = _IF_ ( _UsePowerVeg_ _LT_ _NearZero_ ) _THEN_ _uFunTmVeg_ _ELSE_ _POW_ ( _cQ10ProdVeg_ , (0.1 * (_uTmVegAve_ - _cTmRef_))) _ENDIF_;
_uhLVeg_ = _hLRefVeg_ * _uFunTmProdVeg_;
_aLPIVeg_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ _AND_  _uVegHeight_ _GT_ _sDepthWHyp_ ) _THEN_ _cPMax_*(_aLPAR1VegEpi_- _aLPARVegLight_ + _uhLVeg_*_LN_((1.0 +_aLPARVegLight_/ _uhLVeg_)  /(1.0 +_aLPAR1VegEpi_  / _uhLVeg_) + _NearZero_  ) )_ELSEIF_  ( _aInclStrat_ _EQ_ _TRUE_ _AND_  _uVegHeight_ _LE_ _sDepthWHyp_ ) _THEN_ _cPMax_*( _aLPAR1VegHyp_- _aLPARVegLight_ + _uhLVeg_* _LN_((1.0 +_aLPARVegLight_/ _uhLVeg_)  / (1.0 +_aLPAR1VegHyp_  / _uhLVeg_) ) ) _ELSE_ _cPMax_ * (_aLPAR1VegEpi_- _aLPARVegLight_ + _uhLVeg_*_LN_((1.0 +_aLPARVegLight_/ _uhLVeg_)  /(1.0 +_aLPAR1VegEpi_  / _uhLVeg_) + _NearZero_  ) )_ENDIF_;
_uDayWinVeg_ = _IF_ _UseLWinVeg_ _LE_ _NearZero_ _THEN_ _cDayWinVeg_ _ELSEIF_ (_Day_ _LT_ 1.0 _OR_ _sTime_ _LT_ _BeginTime_ + 1.0) _THEN_ 367 _ELSEIF_ (( _aLPIVeg_ / _uVegHeightLight_ )_LE_ _cLAlloVeg_ _AND_ _uDayWinVeg_ _GT_ 366 _AND_ _Day_ _GT_ 183 ) _THEN_ _Day_ _ELSE_ _uDayWinVeg_ _ENDIF_;
_bfRootVeg_ = _IF_ (_FALSE_ _EQ_ _InclSeason_) _THEN_ _fRootVegSum_ _ELSEIF_ (_Day_ _LT_ _aDayInitVeg_) _THEN_ _fRootVegWin_ _ELSEIF_ (_Day_ _LT_ _aDayInitVeg_ + _cLengAllo_) _THEN_ 0.5*(_fRootVegWin_ + _fRootVegSum_) + 0.5*(_fRootVegWin_ - _fRootVegSum_) * _COS_(_Pi_/_cLengAllo_ * (_Day_ - _aDayInitVeg_)) _ELSEIF_ (_Day_ _LT_ _uDayWinVeg_) _THEN_ _fRootVegSum_ _ELSEIF_ (_Day_ _LT_ _uDayWinVeg_ + _cLengAllo_) _THEN_ 0.5*(_fRootVegWin_ + _fRootVegSum_) - 0.5*(_fRootVegWin_ - _fRootVegSum_) * _COS_(_Pi_/_cLengAllo_ * (_Day_ - _uDayWinVeg_)) _ELSE_ _fRootVegWin_ _ENDIF_;
...
_aExtVegHyp_ = _cExtSpVeg_ * _aDSubVeg_ / _sDepthWHyp_ * (_uVegHeightHyp_ /_uDepthW_ );
_aExtCoefHyp_ = _aExtCoefOpenHyp_ + _aExtVegHyp_;
_aExtVegEpi_ = _cExtSpVeg_ * _aDSubVeg_ / _sDepthWEpi_ * (_uVegHeightEpi_ /_uDepthW_ ) ;
_aExtCoefEpi_ = _aExtCoefOpenEpi_ + _aExtVegEpi_;
_aLPARBotEpi_ = _aLPARBotSurf_ * _EXP_(- _aExtCoefEpi_ * _sDepthWEpi_);
...
_uQOutEpi_ = _IF_ (_FALSE_ _EQ_ _ConstDepth_) _THEN_ 0.0 _ELSEIF_ (_ReadQOut_ _EQ_ _TRUE_) _THEN_ _MAX_(_mQOut_, (_sDepthWEpi_ - _cDepthWMax_) * _cMaxWOut_ * _mmPerm_) _ELSEIF_ (_FALSE_ _EQ_ _aInclStrat_) _THEN_ _MAX_(0.0, (_uQIn_ - _uQInExtra_) - _uQEv_ - _cQInf_ ) + _uQOutExtra_ _ELSE_ _MAX_(0.0, (_uQIn_ - _uQInExtra_) - _uQEv_ - _cQInf_ ) + _uQOutExtra_ _ENDIF_;
_uQOutHyp_ = 0.0;
_uQDilEpi_ = _uQOutEpi_;
_uQDilHyp_ = _uQOutHyp_;
_ukDilEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uQDilEpi_ / _mmPerm_ / _sDepthWEpi_ _ENDIF_;
_ukDilHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uQDilHyp_ / _mmPerm_ / _sDepthWHyp_ _ENDIF_;
_ukDilWatEpi_ = _uQIn_ / _mmPerm_ / _sDepthWEpi_;
_ukDilWatHyp_ = 0.0;
_ukOutEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uQOutEpi_ / _mmPerm_ / _sDepthWEpi_ _ENDIF_;
_ukOutHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uQOutHyp_ / _mmPerm_ / _sDepthWHyp_ _ENDIF_;
_uTauWatEpi_ = _IF_ ( _aInclStrat_ _EQ_ _FALSE_ _AND_ _cQInf_ _LT_ 0.0 ) _THEN_ 1.0 / ((_uQIn_ - _cQInf_) / _mmPerm_ / _sDepthWEpi_ +_NearZero_) _ELSE_ 1.0 / ((_uQIn_ ) / _mmPerm_ / _sDepthWEpi_ +_NearZero_) _ENDIF_;
_uTauWatHyp_ = _IF_ ( _aInclStrat_ _EQ_ _FALSE_ )_THEN_ -9999 _ELSEIF_ (_cQInf_ _LT_ 0.0 ) _THEN_ 1.0 / ((- _cQInf_ ) / _mmPerm_ / _sDepthWHyp_ +_NearZero_) _ELSE_ 1.0 / ( _cQInf_ / _mmPerm_ / _sDepthWHyp_ +_NearZero_) _ENDIF_;
...
_vTranHypEpiW_ = _IF_ (_InclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSEIF_ ( _uDepthW_ -_uDepthMix_ _LT_ _cMinDepthHypEpi_ ) _THEN_ ( _uDepthW_ - _cMinDepthHypEpi_ -_sDepthWEpi_ ) * _kExchW_ _ELSEIF_ ( _uDepthMix_ _LT_ _cMinDepthHypEpi_ ) _THEN_ ( _cMinDepthHypEpi_ -_sDepthWEpi_ ) * _kExchW_ _ELSE_ ( _uDepthMix_ -_sDepthWEpi_ ) * _kExchW_ _ENDIF_;
_vDeltaWHyp_ = _IF_ ( _ConstDepth_ _EQ_ _TRUE_ _OR_ _FALSE_ _EQ_ _aInclStrat_ ) _THEN_ 0.0 _ELSEIF_ (_FALSE_ _EQ_ _InclMarsh_ _OR_ _fMarsh_ _LE_ _NearZero_ ) _THEN_ ( - _cQInf_ - _uQOutHyp_) / _mmPerm_ _ELSE_ ( - _cQInf_ - _uQOutHyp_) / _mmPerm_ / (1.0 + _fMarsh_ ) _ENDIF_;
_vDeltaWEpi_ = _IF_ (_ConstDepth_ _EQ_ _TRUE_ ) _THEN_ 0.0 _ELSEIF_ ( _FALSE_ _EQ_ _InclMarsh_ _OR_ _fMarsh_ _LE_ _NearZero_ ) _THEN_ (_uQIn_ - _uQEv_ - _uQOutEpi_ - _cQInf_ ) / _mmPerm_ _ELSE_ (_uQIn_ - _uQEv_ - _uQOutEpi_ - _cQInf_ ) / _mmPerm_ / (1.0 + _fMarsh_ ) _ENDIF_;
_afVolHypEpi_= _IF_ (_aInclStrat_ _EQ_ _TRUE_ _AND_ _sDepthWHyp_ _GT_ _NearZero_) _THEN_  _sDepthWHyp_ / _sDepthWEpi_ _ELSE_ 0.0 _ENDIF_;
...
_tDAdvTotWEpi_ = _wDAdvIMW_ + _wDAdvDetW_ + _wDAdvDiatW_ + _wDAdvGrenW_ + _wDAdvBlueW_ + _wDAdvZooW_;
_tDAdvTotWHyp_ = _sDepthWHyp_ * (_wDAdvIMW_ + _wDAdvDetW_ + _wDAdvDiatW_ + _wDAdvGrenW_ + _wDAdvBlueW_ + _wDAdvZooW_) / _sDepthWHyp_;
...
_afVolMarshEpi_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _fMarsh_ * _sDepthWM_ / _sDepthWEpi_ _ELSE_ 0.0 _ENDIF_;
_tDAdvTotWMEpi_ = (_wDAdvIMWM_ + _wDAdvDetWM_ + _wDAdvDiatWM_ + _wDAdvGrenWM_ + _wDAdvBlueWM_ + _wDAdvZooWM_) * _afVolMarshEpi_;
...
_akExchWHyp_= _IF_ (_aInclStrat_ _EQ_ _TRUE_ _AND_ _sDepthWHyp_ _GT_ _NearZero_) _THEN_  ( _uExchMaxW_ ) / _sDepthWHyp_ _ELSE_ 0.0 _ENDIF_;
...
_tDExchTotWEpi_ = (_wDExchIMWEpi_+_wDExchDetWEpi_ +_wDExchDiatWEpi_  +_wDExchGrenWEpi_ +_wDExchBlueWEpi_ +_wDExchZooWEpi_) * _sDepthWEpi_;
_tDExchTotWHyp_ = (_wDExchIMWHyp_+_wDExchDetWHyp_ +_wDExchDiatWHyp_  +_wDExchGrenWHyp_ +_wDExchBlueWHyp_ +_wDExchZooWHyp_) * _sDepthWHyp_;
_akExchMHyp_ = 0.0;
_akExchLHyp_ = 0.0;
...
_aDPhytS_ = _sDDiatS_ + _sDGrenS_ + _sDBlueS_ ;
_aPPhytS_ = _sPDiatS_ + _sPGrenS_ + _sPBlueS_ ;
_aNPhytS_ = _sNDiatS_ + _sNGrenS_ + _sNBlueS_;
...
_aDTotM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ ((_oDIMWM_ + _oDDetWM_ + _oDPhytWM_ + _oDZooM_) * _sDepthWM_ + _sDIMSM_ + _sDHumSM_ + _sDDetSM_ + _sDShootPhra_ + _sDRootPhra_) * _fMarsh_ _ELSE_ 0.0 _ENDIF_;
_aPTotM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ ((_oPO4WM_ + _oPDetWM_ + _oPAIMWM_ + _oPPhytWM_ + _oPZooM_) * _sDepthWM_ + _sPO4SM_ + _sPHumSM_ + _sPDetSM_ + _sPAIMSM_ + _sPShootPhra_ + _sPRootPhra_) * _fMarsh_ _ELSE_ 0.0 _ENDIF_;
_aNTotM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ ((_oNH4WM_ + _oNO3WM_ + _oNDetWM_ + _oNPhytWM_ + _oNZooM_) * _sDepthWM_ + _sNH4SM_ + _sNO3SM_ + _sNHumSM_ + _sNDetSM_ + _sNShootPhra_ + _sNRootPhra_) * _fMarsh_ _ELSE_ 0.0 _ENDIF_;
_aSiTotM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ ((_oSiO2WM_ + _oSiDetWM_ + _oSiDiatWM_) * _sDepthWM_ + _sSiDetSM_) * _fMarsh_ _ELSE_ 0.0 _ENDIF_;
_aO2TotM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ ((_oO2WM_) * _sDepthWM_ ) * _fMarsh_ _ELSE_ 0.0 _ENDIF_;
...
_tSiTranTotTHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - (_wSiDilDetHyp_ + _wSiDilSiO2Hyp_ + _wSiDilDiatHyp_) * _sDepthWHyp_ _ENDIF_;
...
_tDTranTotTHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ - _wDDilTotHyp_ * _sDepthWHyp_ _ENDIF_;
_tPTranTotTHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uPLoad_ - _wPDilTotHyp_ * _sDepthWHyp_ _ENDIF_;
_tNTranTotTHyp_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uNLoad_ - _wNDilTotHyp_ * _sDepthWHyp_ _ENDIF_;
...
_uFunTmAerEpi_ = _POW_(_cThetaAer_ , (_uTmEpi_-_cTmRef_));
_uFunTmAerHyp_ = _POW_(_cThetaAer_ , (_uTmHyp_-_cTmRef_));
_aFunLemnAer_ = 1.0;
...
_aFunDimSusp_ = _IF_ (_uTmEpi_ _GE_ 0.1) _THEN_ _cSuspRef_ * ((_cSuspMin_ + _cSuspMax_ / (1.0 + _EXP_(_cSuspSlope_ * (_uDepthW_ - _hDepthSusp_)))) * _POW_(((_cFetch_ +_NearZero_)/ _cFetchRef_) , (0.5))) _ELSE_ 0.0 _ENDIF_;
...
_aFunTauSetOMHyp_ = _MIN_(1.0 / _POW_(_aFunDimSusp_ +_NearZero_ , (0.5)), 1.0);
_aFunTauSetIMHyp_ = _aFunTauSetOMHyp_;
_uFunTmSetEpi_ = _POW_(_cThetaSet_ , (_uTmEpi_-_cTmRef_));
_uFunTmSetHyp_ = _POW_(_cThetaSet_ , (_uTmHyp_-_cTmRef_));
_uCorVSetIMHyp_ = _aFunTauSetIMHyp_ * _POW_((_fLutumRef_/_fLutum_) , (0.5)) * _uFunTmSetHyp_ * _cVSetIM_;
...
_uFunTmMinWEpi_ = _POW_(_cThetaMinW_ , (_uTmEpi_-_cTmRef_));
_uFunTmMinWHyp_ = _POW_(_cThetaMinW_ , (_uTmEpi_-_cTmRef_));
...
_uFunTmNitrHyp_ = _POW_(_cThetaNitr_ , (_uTmHyp_-_cTmRef_));
_uFunTmNitrEpi_ = _POW_(_cThetaNitr_ , (_uTmEpi_-_cTmRef_));
_uFunTmNitrS_ = _POW_(_cThetaNitr_ , (_uTmBot_-_cTmRef_));
...
_uFunTmMinS_ = _POW_(_cThetaMinS_ , (_uTmBot_-_cTmRef_));
...
_uFunTmDif_ = _POW_(_cThetaDif_ , (_uTmEpi_-_cTmRef_));
_akO2DifCor_ = _kO2Dif_ * _uFunTmDif_ * _cTurbDifO2_ * _bPorCorS_;
_tSOD_ = (_molO2molC_ * _cCPerDW_ * (1.0 - _fRefrDetS_) * _tDMinDetS_ + _O2PerNH4_ * _molO2molN_ * _kNitrS_ * _uFunTmNitrS_ * _sNH4S_) / _cDepthS_;
...
_tSODM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_(_molO2molC_ * _cCPerDW_ *(1.0 - _fRefrDetS_) * _tDMinDetSM_ + _O2PerNH4_ * _molO2molN_ * _kNitrS_ * _uFunTmNitrEpi_ * _sNH4SM_) / _cDepthSM_ _ELSE_ 0.0 _ENDIF_;
_aDepthOxySedM_ = _IF_ (_InclMarsh_ _EQ_ _FALSE_ _OR_ _fMarsh_ _LE_ _NearZero_) _THEN_ 0.0 _ELSEIF_ (2.0 * _oO2WM_ * _akO2DifCorM_ / _tSODM_) _LE_ _NearZero_ _THEN_ _POW_( _NearZero_ , (0.5)) _ELSE_ _POW_((2.0 * _oO2WM_ * _akO2DifCorM_ / _tSODM_) , (0.5)) _ENDIF_ ;
...
_tNNitrSM_ = _IF_ (_InclMarsh_ _EQ_ _TRUE_ _AND_ _fMarsh_ _GT_ _NearZero_) _THEN_ _afOxySedM_ * _kNitrS_ * _uFunTmNitrEpi_ * _sNH4SM_ _ELSE_ 0.0 _ENDIF_;
...
_aPVeg_ = _sPVeg_;
_aNVeg_ = _sNVeg_;
_aLPARBotHyp_ = _uLPARSurfHyp_ * _EXP_(- _aExtCoefHyp_ * _sDepthWHyp_);
...
_uFunTmRespVeg_ = _IF_ ( _UsePowerVeg_ _LT_ _NearZero_ ) _THEN_ _uFunTmVeg_ _ELSE_ _POW_(_cQ10RespVeg_ , (0.1 * (_uTmVegAve_ - _cTmRef_))) _ENDIF_;
...
_tPUptVegEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _tPUptVegWEpi_ + _tPUptVegS_ * _uDVegEpi_ / _sDVeg_ _ELSEIF_ (_aInclStrat_ _EQ_ _FALSE_ _AND_ _FALSE_ _EQ_ _UseEmpUpt_) _THEN_ _tPUptVegWEpi_ + _tPUptVegS_ _ELSE_ _tPUptVegWEpi_ + _tPUptVegS_ _ENDIF_;
_tPUptVegHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSEIF_ (_FALSE_ _EQ_ _UseEmpUpt_) _THEN_ _tPUptVegWHyp_ + _tPUptVegS_ * _uDVegHyp_ / _sDVeg_ _ELSE_ _tPUptVegWHyp_ + _tPUptVegS_ * _uDVegHyp_ / _sDVeg_ _ENDIF_ ;
...
_tNUptVegSEpi_ = _IF_ (_FALSE_ _EQ_ _UseEmpUpt_) _THEN_ _aVNUptVegS_ * _aDRootVeg_ _ELSE_ _afNUptVegS_ * _aVNUptMaxCrVeg_ * _oNDissS_ / (_aVNUptMaxCrVeg_ / _cAffNUptVeg_ + _oNDissS_) * _sDVeg_ _ENDIF_;
...
_aLLimShootVegEpi_ = _fEmergVeg_ + _fFloatVeg_ * (1.0 - _afCovEmergVeg_) + _bfSubVegEpi_ * (1.0 - _afCovSurfVeg_) * 1.0 / (_aExtCoefEpi_ * _sDepthWEpi_) * _LN_( (1.0 + _aLPAR1VegEpi_ / _uhLVeg_) / (1.0 + _aLPAR2VegEpi_ / _uhLVeg_));
_aLLimShootVegHyp_ = _fEmergVeg_ + _fFloatVeg_ * (1.0 - _afCovEmergVeg_) + _bfSubVegHyp_ * (1.0 - _afCovSurfVeg_) * 1.0 / (_aExtCoefHyp_ * _sDepthWHyp_) * _LN_( (1.0 + _aLPAR1VegHyp_ / _uhLVeg_) / (1.0 + _aLPAR2VegHyp_ / _uhLVeg_));
...
_bkMortVeg_ = _IF_ (_FALSE_ _EQ_ _InclSeason_) _THEN_ _kMortVegSum_ _ELSEIF_ (_Day_ _LT_ _uDayWinVeg_) _THEN_ _kMortVegSum_ _ELSEIF_ (_Day_ _LT_ _uDayWinVeg_ + _cLengMort_) _THEN_ - _LN_(_fWinVeg_) / _cLengMort_ _ELSE_ _kMortVegSum_ _ENDIF_;
_akDIncrVegHyp_ = _aMuTmLVegHyp_ - _kDRespVeg_ * _uFunTmRespVeg_ - _bkMortVeg_;
_tDEnvVegHyp_ = _MAX_(0.0, _akDIncrVegHyp_ / (_cDCarrVeg_+_NearZero_) * _sDVeg_*_sDVeg_);
...
_wDBedDetWHyp_ =_IF_ (_aInclStrat_ _EQ_ _TRUE_ _AND_ _InclVeg_ _EQ_ _TRUE_) _THEN_ (_tDMortVegWHyp_) / _sDepthWHyp_ _ELSE_ 0.0 _ENDIF_;
...
_tDEnvVegEpi_ = _MAX_(0.0, _akDIncrVegEpi_ / (_cDCarrVeg_+_NearZero_) * _sDVeg_*_sDVeg_);
...
_wPBedPO4WHyp_ =_IF_ (_aInclStrat_ _EQ_ _TRUE_ _AND_ _InclVeg_ _EQ_ _TRUE_ ) _THEN_ (- _tPUptVegWHyp_ + _tPExcrVegW_ * _uVegHeightHyp_ / _uVegHeight_ + _tPMortVegPO4WHyp_ ) /_sDepthWHyp_ _ELSE_ 0.0 _ENDIF_;
_wPBedDetWHyp_ =_IF_ (_aInclStrat_ _EQ_ _TRUE_ _AND_ _InclVeg_ _EQ_ _TRUE_) _THEN_ (_tPMortVegDetWHyp_ ) / _sDepthWHyp_ _ELSE_ 0.0 _ENDIF_;
_wNBedNH4WHyp_ =_IF_ (_aInclStrat_ _EQ_ _TRUE_ _AND_ _InclVeg_ _EQ_ _TRUE_ ) _THEN_ (- _tNUptNH4VegWHyp_ + _tNExcrVegW_ * (_uVegHeightHyp_ /_uVegHeight_ ) + _tNMortVegNH4WHyp_ ) / _sDepthWHyp_ _ELSE_ 0.0 _ENDIF_;
_wNBedNO3WHyp_ =_IF_ (_aInclStrat_ _EQ_ _TRUE_ _AND_ _InclVeg_ _EQ_ _TRUE_) _THEN_ - _tNUptNO3VegWHyp_ / _sDepthWHyp_ _ELSE_ 0.0 _ENDIF_;
_wNBedDetWHyp_ =_IF_ (_aInclStrat_ _EQ_ _TRUE_ _AND_ _InclVeg_ _EQ_ _TRUE_) _THEN_ (_tNMortVegDetWHyp_ ) / _sDepthWHyp_ _ELSE_ 0.0 _ENDIF_;
...
_aLPARAveEpi_ = (_aLPARBotSurf_ - _aLPARBotEpi_)/ (_aExtCoefOpenEpi_ * _sDepthWEpi_);
_aLPARAveHyp_ = (_aLPARBotEpiOpen_ -_aLPARBotHyp_)/ (_aExtCoefOpenHyp_ * _sDepthWEpi_);
...
_tNUptBlueHyp_ = _wNUptBlueHyp_ * _sDepthWHyp_;
...
_aLLimBlueHyp_ = _UseSteeleBlue_ *(_EXP_(1.0) /(_aExtCoefHyp_ * _sDepthWHyp_) *(_EXP_(- _aLPARBotHyp_ /(_cLOptRefBlue_ * _uFunTmProdBlueHyp_)) - _EXP_(- _uLPARSurfHyp_ /(_cLOptRefBlue_ * _uFunTmProdBlueHyp_)))) +(1.0 - _UseSteeleBlue_) *(1.0 /(_aExtCoefHyp_ * _sDepthWHyp_) * _LN_((1.0 + _uLPARSurfHyp_ / (_hLRefBlue_ * _uFunTmProdBlueHyp_)) / (1.0 + _aLPARBotHyp_ /(_hLRefBlue_ * _uFunTmProdBlueHyp_))));
...
_wNUptBlueWHyp_ = _tNUptBlueWHyp_ / _sDepthWHyp_;
...
_aLLimBlueEpi_ = _UseSteeleBlue_ *(_EXP_(1.0) /(_aExtCoefEpi_ * _sDepthWEpi_) *(_EXP_(- _aLPARBotEpi_ /(_cLOptRefBlue_ * _uFunTmProdBlueEpi_)) - _EXP_(- _aLPARBotSurf_ /(_cLOptRefBlue_ * _uFunTmProdBlueEpi_)))) +(1.0 - _UseSteeleBlue_) *(1.0 /(_aExtCoefEpi_ * _sDepthWEpi_) * _LN_((1.0 + _aLPARBotSurf_ / (_hLRefBlue_ * _uFunTmProdBlueEpi_)) / (1.0 + _aLPARBotEpi_ /(_hLRefBlue_ * _uFunTmProdBlueEpi_))));
...
_oChlaBlueW_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ (_oChlaBlueEpi_ * _sDepthWEpi_ + _oChlaBlueHyp_ * _sDepthWHyp_) / _uDepthW_ _ELSE_ (_oChlaBlueEpi_ * _sDepthWEpi_) / _uDepthW_ _ENDIF_;
...
_uVFloTest_ = _IF_ (_InclSurf_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSEIF_ (_Day_ _LT_ 150) _THEN_ 0.0 _ELSEIF_ (_Day_ _LT_ 210) _THEN_ _cVFloBlueW_ _ELSE_ 0.0 _ENDIF_;
_uVFloBlueSurf_ =  _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSEIF_ (_TestSurf_ _EQ_ _TRUE_) _THEN_ _uVFloTest_ _ELSE_ _aTrigFloBlueSurf_ * _cVFloMaxBlueW_ _ENDIF_;
_uVFloBlueEpi_ = _IF_ (_InclSurf_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSEIF_ (_TestSurf_ _EQ_ _TRUE_) _THEN_ _uVFloTest_ _ELSE_ _aTrigFloBlueEpi_ * _cVFloMaxBlueW_ _ENDIF_;
_uVFloBlueHyp_ =  _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSEIF_ (_InclSurf_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSEIF_ (_TestSurf_ _EQ_ _TRUE_) _THEN_ _uVFloTest_ _ELSE_ _aTrigFloBlueHyp_ * _cVFloMaxBlueW_ _ENDIF_;
...
_tDRespBlueS_ = _ukDRespTmBlueS_ * _sDBlueS_;
_tDMortBlueS_ = _kMortBlueS_ * _sDBlueS_;
_ukDDecBlueHyp_ = _ukDRespTmBlueHyp_ + _ukLossTmBlueHyp_ + _kMortBlueW_ +(_uCorVSetBlueHyp_ * _uFunTmSetHyp_) / _sDepthWHyp_;
...
_wDPrimBlueWHyp_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wDAssBlueHyp_ - _wDRespBlueWHyp_ - _wDLossBlueHyp_ - _wDMortBlueWHyp_ + (_tDResusBlue_ + _tDSetBlueEpi_ - _tDSetBlueHyp_ - _tDFloBlueHyp_) / _sDepthWHyp_ _ENDIF_;
_wPPrimBlueWHyp_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wPUptBlueHyp_ - _wPExcrBlueWHyp_ - _wPLossBlueHyp_ - _wPMortBlueWHyp_+ (_tPResusBlue_ + _tPSetBlueEpi_ - _tPSetBlueHyp_ - _tPFloBlueHyp_) / _sDepthWHyp_ _ENDIF_;
_wNPrimBlueWHyp_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wNUptBlueHyp_ - _wNExcrBlueWHyp_ - _wNLossBlueHyp_ - _wNMortBlueWHyp_+ (_tNResusBlue_ + _tNSetBlueEpi_ - _tNSetBlueHyp_ - _tNFloBlueHyp_) / _sDepthWHyp_ _ENDIF_;
...
_aLLimGrenHyp_ = _UseSteeleGren_ *(_EXP_(1.0) /(_aExtCoefHyp_ * _sDepthWHyp_) *(_EXP_(- _aLPARBotHyp_ /(_cLOptRefGren_ * _uFunTmProdGrenHyp_)) - _EXP_(- _uLPARSurfHyp_ /(_cLOptRefGren_ * _uFunTmProdGrenHyp_)))) +(1.0 - _UseSteeleGren_) *(1.0 /(_aExtCoefHyp_ * _sDepthWHyp_) * _LN_((1.0 + _uLPARSurfHyp_ / (_hLRefGren_ * _uFunTmProdGrenHyp_)) / (1.0 + _aLPARBotHyp_ /(_hLRefGren_ * _uFunTmProdGrenHyp_))));
...
_tDRespGrenS_ = _ukDRespTmGrenS_ * _sDGrenS_;
_tDMortGrenS_ = _kMortGrenS_ * _sDGrenS_;
_ukDDecGrenHyp_ = _ukDRespTmGrenHyp_ + _ukLossTmGrenHyp_ + _kMortGrenW_ +(_uCorVSetGrenHyp_ * _uFunTmSetHyp_) / _sDepthWHyp_;
...
_wDPrimGrenWHyp_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wDAssGrenHyp_ - _wDRespGrenWHyp_ - _wDLossGrenHyp_ - _wDMortGrenWHyp_ -(_tDSetGrenHyp_ -_tDSetGrenEpi_ - _tDResusGren_) / _sDepthWHyp_ _ENDIF_;
_wPPrimGrenWHyp_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wPUptGrenHyp_ - _wPExcrGrenWHyp_ - _wPLossGrenHyp_ - _wPMortGrenWHyp_ -(_tPSetGrenHyp_ -_tPSetGrenEpi_ - _tPResusGren_) / _sDepthWHyp_ _ENDIF_;
_wNPrimGrenWHyp_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wNUptGrenHyp_ - _wNExcrGrenWHyp_ - _wNLossGrenHyp_ - _wNMortGrenWHyp_ -(_tNSetGrenHyp_ -_tNSetGrenEpi_ - _tNResusGren_) / _sDepthWHyp_ _ENDIF_;
...
_aLLimDiatHyp_ = _UseSteeleDiat_ *(_EXP_(1.0) /(_aExtCoefHyp_ * _sDepthWHyp_) *(_EXP_(- _aLPARBotHyp_ /(_cLOptRefDiat_ * _uFunTmProdDiatHyp_)) - _EXP_(- _uLPARSurfHyp_ /(_cLOptRefDiat_ * _uFunTmProdDiatHyp_)))) +(1.0 - _UseSteeleDiat_) *(1.0 /(_aExtCoefHyp_ * _sDepthWHyp_) * _LN_((1.0 + _uLPARSurfHyp_ / (_hLRefDiat_ * _uFunTmProdDiatHyp_)) / (1.0 + _aLPARBotHyp_ /(_hLRefDiat_ * _uFunTmProdDiatHyp_))));
...
_tDRespDiatS_ = _ukDRespTmDiatS_ * _sDDiatS_;
_tDMortDiatS_ = _kMortDiatS_ * _sDDiatS_;
_ukDDecDiatHyp_ = _ukDRespTmDiatHyp_ + _ukLossTmDiatHyp_ + _kMortDiatW_ +(_uCorVSetDiatHyp_ * _uFunTmSetHyp_) / _sDepthWHyp_;
...
_wDPrimDiatWHyp_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wDAssDiatHyp_ - _wDRespDiatWHyp_ - _wDLossDiatHyp_ - _wDMortDiatWHyp_ -(_tDSetDiatHyp_ - _tDSetDiatEpi_ - _tDResusDiat_) / _sDepthWHyp_ _ENDIF_;
_wPPrimDiatWHyp_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wPUptDiatHyp_ - _wPExcrDiatWHyp_ - _wPLossDiatHyp_ - _wPMortDiatWHyp_ -(_tPSetDiatHyp_ -_tPSetDiatEpi_ - _tPResusDiat_) / _sDepthWHyp_ _ENDIF_;
_wNPrimDiatWHyp_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wNUptDiatHyp_ - _wNExcrDiatWHyp_ - _wNLossDiatHyp_ - _wNMortDiatWHyp_ -(_tNSetDiatHyp_ - _tNSetDiatEpi_ - _tNResusDiat_) / _sDepthWHyp_ _ENDIF_;
...
_wSiPrimSiO2WHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wSiExcrDiatWHyp_ - _wSiUptDiatHyp_ + _tSiExcrDiatS_ / _sDepthWHyp_ _ENDIF_;
...
_bSecchiMaxEpi_ = _sDepthWEpi_;
_aSecchiEpi_ = _MIN_(_bSecchiMaxEpi_,_aPACoefEpi_ / _aExtCoefOpenEpi_);
_aTransparencyEpi_ = _aSecchiEpi_ / _sDepthWEpi_;
_bSecchiMaxHyp_ = _sDepthWHyp_ + _cSecchiPlus_;
_aSecchiHyp_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ _AND_ _sDepthWEpi_ _LE_ _aPACoefEpi_ / _aExtCoefOpenEpi_ ) _THEN_ _MIN_(_bSecchiMaxHyp_,_aPACoefHyp_ / _aExtCoefOpenHyp_ - _aSecchiEpi_) _ELSEIF_ ( _aInclStrat_ _EQ_ _TRUE_ _AND_ _sDepthWEpi_ _GT_ _aPACoefEpi_ / _aExtCoefOpenEpi_) _THEN_ 0.0 _ELSE_ _MIN_(_bSecchiMaxHyp_,_aPACoefHyp_ / _aExtCoefOpenHyp_) _ENDIF_;
_aSecchiT_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _aSecchiEpi_ +_aSecchiHyp_ _ELSE_ _aSecchiHyp_ _ENDIF_;
_aTransparencyHyp_ = _aSecchiHyp_ / _sDepthWHyp_;
_aTransparencyT_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _aSecchiT_ / _uDepthW_ _ELSE_ _aSecchiT_ / _sDepthWHyp_ _ENDIF_;
_aDepthEuphHyp_ = _cEuph_ * _aSecchiHyp_;
_aRelDepthEuphHyp_ = _aDepthEuphHyp_ / _sDepthWHyp_;
_aChlaHHyp_ = _oChlaHyp_ * _sDepthWHyp_;
_aCovPhytWHyp_ = _cCovSpPhyt_ *(_oDPhytWHyp_ * _sDepthWHyp_);
...
_bDayInitPhra_ = _IF_ (_Day_ _LT_ 1.0 _OR_ _sTime_ _LT_ _BeginTime_ + 1.0) _THEN_ 367 _ELSEIF_ (_uTmEpi_ _GE_ _cTmInitPhra_ _AND_ _bDayInitPhra_ _GT_ 366) _THEN_ _Day_ _ELSE_ _bDayInitPhra_ _ENDIF_;
...
_wDTranDiatEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uDLoadDiat_ / _sDepthWEpi_ - _wDDilDiatEpi_ _ENDIF_;
_wPTranDiatEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uPLoadDiat_ / _sDepthWEpi_ - _wPDilDiatEpi_ _ENDIF_;
_wNTranDiatEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uNLoadDiat_ / _sDepthWEpi_ - _wNDilDiatEpi_ _ENDIF_;
_wDTranGrenEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uDLoadGren_ / _sDepthWEpi_ - _wDDilGrenEpi_ _ENDIF_;
_wPTranGrenEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uPLoadGren_ / _sDepthWEpi_ - _wPDilGrenEpi_ _ENDIF_;
_wNTranGrenEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uNLoadGren_ / _sDepthWEpi_ - _wNDilGrenEpi_ _ENDIF_;
_wDTranBlueEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uDLoadBlue_ / _sDepthWEpi_ - _wDDilBlueEpi_ _ENDIF_;
_wPTranBlueEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uPLoadBlue_ / _sDepthWEpi_ - _wPDilBlueEpi_ _ENDIF_;
_wNTranBlueEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uNLoadBlue_ / _sDepthWEpi_ - _wNDilBlueEpi_ _ENDIF_;
...
_wSiTranSiO2Epi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uSiLoadSiO2_ / _sDepthWEpi_ - _wSiDilSiO2Epi_ _ENDIF_;
_wSiTranDetWEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uSiLoadDet_ / _sDepthWEpi_ - _wSiDilDetEpi_ _ENDIF_;
_tSiTranTotTEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uSiLoadSiO2_ + _uSiLoadDet_ + _uSiLoadDiat_ - (_wSiDilDetEpi_ + _wSiDilSiO2Epi_ + _wSiDilDiatEpi_) * _sDepthWEpi_ _ENDIF_;
...
_wDTranIMWEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uDLoadIM_ / _sDepthWEpi_ - _wDDilIMEpi_ _ENDIF_;
_wDTranDetWEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uDLoadDet_ / _sDepthWEpi_ - _wDDilDetEpi_ _ENDIF_;
_wO2TranWEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _wO2InflowEpi_ - _wO2OutflEpi_ _ENDIF_;
_wPTranPO4WEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uPLoadPO4_ / _sDepthWEpi_ - _wPDilPO4Epi_ _ENDIF_;
_wPTranAIMWEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uPLoadAIM_ / _sDepthWEpi_ - _wPDilAIMEpi_ _ENDIF_;
_wPTranDetWEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uPLoadDet_ / _sDepthWEpi_ - _wPDilDetEpi_ _ENDIF_;
_wNTranNH4WEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uNLoadNH4_ / _sDepthWEpi_ - _wNDilNH4Epi_ _ENDIF_;
_wNTranNO3WEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uNLoadNO3_ / _sDepthWEpi_ - _wNDilNO3Epi_ _ENDIF_;
_wNTranDetWEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uNLoadDet_ / _sDepthWEpi_ - _wNDilDetEpi_ _ENDIF_;
...
_tDTranTotTEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uDLoad_ - _wDDilTotEpi_ * _sDepthWEpi_ _ENDIF_;
_tPTranTotTEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uPLoad_ - _wPDilTotEpi_ * _sDepthWEpi_ _ENDIF_;
_tNTranTotTEpi_ = _IF_ (_FALSE_ _EQ_ _InclTran_) _THEN_ 0.0 _ELSE_ _uNLoad_ - _wNDilTotEpi_ * _sDepthWEpi_ _ENDIF_;
_tDTranTotWEpi_ = (_wDTranIMWEpi_ + _wDTranDetWEpi_ + _wDTranDiatEpi_ + _wDTranGrenEpi_ + _wDTranBlueEpi_ + _wDTranZooEpi_) * _sDepthWEpi_;
_tDTranTotWHyp_ = (_wDTranIMWHyp_ + _wDTranDetWHyp_ + _wDTranDiatHyp_ + _wDTranGrenHyp_ + _wDTranBlueHyp_ + _wDTranZooHyp_) * _sDepthWHyp_;
_tNTranTotW_ = (_uNBackLoadHyp_ / _sDepthWHyp_ + _wNTranNH4WHyp_ + _wNTranNO3WHyp_ + _wNTranDetWHyp_ + _wNTranDiatHyp_ + _wNTranGrenHyp_ + _wNTranBlueHyp_ + _wNTranZooHyp_) * _sDepthWHyp_ + (_wNTranNH4WEpi_ + _cNBackLoad_ / _sDepthWEpi_ + _wNTranNO3WEpi_ + _wNTranDetWEpi_ + _wNTranDiatEpi_ + _wNTranGrenEpi_ + _wNTranBlueEpi_ + _wNTranZooEpi_) * _sDepthWEpi_;
...
_tDExchTotW_= - ((_wDExchIMHyp_ + _wDExchDetHyp_+ _wDExchDiatHyp_ + _wDExchGrenHyp_+ _wDExchBlueHyp_+ _wDExchZooHyp_) * _sDepthWHyp_+ (_wDExchIMEpi_ + _wDExchDetEpi_+ _wDExchDiatEpi_ + _wDExchGrenEpi_+ _wDExchBlueEpi_+ _wDExchZooEpi_) * _sDepthWEpi_) ;
_tDExchTotEpi_ = (_wDExchIMEpi_ + _wDExchDetEpi_ + _wDExchDiatEpi_ + _wDExchGrenEpi_ + _wDExchBlueEpi_ + _wDExchZooEpi_) * _sDepthWEpi_;
_tDExchTotHyp_ = (_wDExchIMHyp_ + _wDExchDetHyp_ + _wDExchDiatHyp_ + _wDExchGrenHyp_ + _wDExchBlueHyp_ + _wDExchZooHyp_) * _sDepthWHyp_;
_tNExchTotW_ = (_wNExchNH4Hyp_ + _wNExchNO3Hyp_ + _wNExchDetHyp_ + _wNExchDiatHyp_ + _wNExchGrenHyp_ + _wNExchBlueHyp_ + _wNExchZooHyp_) * _sDepthWHyp_ + (_wNExchNH4Epi_ + _wNExchNO3Epi_ + _wNExchDetEpi_ + _wNExchDiatEpi_ + _wNExchGrenEpi_ + _wNExchBlueEpi_ + _wNExchZooEpi_) * _sDepthWEpi_;
...
_tO2AerEpi_ = _kAer_ * _uFunTmAerEpi_ * (_uO2SatEpi_ - _oO2WEpi_) * _aFunLemnAer_ * _aFunBlueSurfAer_;
...
_tNNitrS_ = _afOxySed_ * _kNitrS_ * _uFunTmNitrS_ * _sNH4S_;
...
_wO2AbioWHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _tO2BubHyp_ / _sDepthWHyp_ - _wO2MinDetWHyp_ - _wO2NitrWHyp_ - (_tO2MinDetS_ + _tO2NitrS_) / _sDepthWHyp_ _ENDIF_;
_wPAbioDetWHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ - _wPMinDetWHyp_ - (_tPSetDetHyp_ - _tPSetDetEpi_ - _tPResusDet_) / _sDepthWHyp_ _ENDIF_;
_wPAbioPO4WHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wPMinDetWHyp_ - _wPSorpIMWHyp_ - _tPInfPO4WHyp_ / _sDepthWHyp_ + _tPDifPO4Hyp_ / _sDepthWHyp_ + _tPResusPO4_ / _sDepthWHyp_ _ENDIF_;
_wPAbioAIMWHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ (- _tPSetAIMHyp_ +_tPSetAIMEpi_ + _tPResusAIM_) / _sDepthWHyp_ + _wPSorpIMWHyp_ _ENDIF_;
_tPAbioTotT_ = _uPErosOM_ - _tPChemPO4_ - _tPInfPO4S_ - _tPDifGroundPO4_;
_wNAbioNH4WHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wNMinDetWHyp_ - _wNNitrWHyp_ - _tNInfNH4WHyp_ / _sDepthWHyp_ + (_tNDifNH4Hyp_ + _tNResusNH4_) / _sDepthWHyp_ _ENDIF_;
_wNAbioNO3WHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wNNitrWHyp_ - _wNDenitWHyp_ + (_tNDifNO3Hyp_ + _tNResusNO3_ - _tNInfNO3WHyp_) / _sDepthWHyp_ _ENDIF_;
_wNAbioDetWHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ - _wNMinDetWHyp_ - (_tNSetDetHyp_ -_tNSetDetEpi_ - _tNResusDet_ ) / _sDepthWHyp_ _ENDIF_;
_wSiAbioSiO2WHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wSiMinDetWHyp_ + (1.0 - _fRefrDetS_) * _tSiMinDetS_ / _sDepthWHyp_ _ENDIF_;
_wSiAbioDetWHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ - _wSiMinDetWHyp_ - (_tSiSetDetHyp_ -_tSiSetDetEpi_ - _tSiResusDet_) / _sDepthWHyp_ _ENDIF_;
_wDAbioDetWHyp_ =_IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ (- _tDSetDetHyp_ + _tDSetDetEpi_ + _tDResusDet_ ) / _sDepthWHyp_ - _wDMinDetWHyp_ _ENDIF_;
_wDAbioIMWHyp_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ (_uDErosIMW_ * _fHypErosIM_ - _tDSetIMHyp_+ _tDSetIMEpi_ + _tDResusIM_) / _sDepthWHyp_ _ENDIF_;
_wDAbioIMWEpi_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ (_uDErosIMW_ * (1- _fHypErosIM_) - _tDSetIMEpi_ ) / _sDepthWEpi_ _ELSE_ (_uDErosIMW_ * (1- _fHypErosIM_) - _tDSetIMEpi_ + _tDResusIM_) / _sDepthWEpi_ _ENDIF_;
_wDAbioDetWEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ (- _tDSetDetEpi_ ) / _sDepthWEpi_ - _wDMinDetWEpi_ _ELSE_ (- _tDSetDetEpi_ + _tDResusDet_ ) / _sDepthWEpi_ - _wDMinDetWEpi_ _ENDIF_;
...
_tDAbioTotW_ = (_wDAbioIMWHyp_ + _wDAbioDetWHyp_) * _sDepthWHyp_ + (_wDAbioIMWEpi_ + _wDAbioDetWEpi_) * _sDepthWEpi_;
_tDAbioTotWEpi_ = (_wDAbioIMWEpi_ + _wDAbioDetWEpi_) * _sDepthWEpi_;
_tDAbioTotWHyp_ = (_wDAbioIMWHyp_ + _wDAbioDetWHyp_) * _sDepthWHyp_;
_tDAbioTotS_ =_tDAbioIMS_ + _tDAbioHumS_ + _tDAbioDetS_;
_tDAbioTotT_ = _cDErosTot_ - _wDMinDetWEpi_ * _sDepthWEpi_ - _wDMinDetWHyp_ * _sDepthWHyp_ - (1.0 - _fRefrDetS_) * _tDMinDetS_ - _tDMinHumS_;
_wO2AbioWEpi_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ _tO2AerEpi_ / _sDepthWEpi_ - _wO2MinDetWEpi_ - _wO2NitrWEpi_ - (_tO2MinDetS_ + _tO2NitrS_) / _sDepthWEpi_ _ELSE_ _tO2AerEpi_ / _sDepthWEpi_ - _wO2MinDetWEpi_ - _wO2NitrWEpi_ _ENDIF_;
_wO2AbioM_ = _tO2AerM_ / _sDepthWM_ - _wO2MinDetWM_ - _wO2NitrWM_ - (_tO2MinDetSM_ + _tO2NitrSM_) / _sDepthWM_;
_wPAbioDetWEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ - _wPMinDetWEpi_ - (_tPSetDetEpi_ ) / _sDepthWEpi_ _ELSE_ - _wPMinDetWEpi_ - (_tPSetDetEpi_ - _tPResusDet_) / _sDepthWEpi_ _ENDIF_;
_wPAbioPO4WEpi_ =_IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wPMinDetWEpi_ - _wPSorpIMWEpi_ - _tPInfPO4WEpi_ / _sDepthWEpi_ + _tPDifPO4Epi_ / _sDepthWEpi_ _ELSE_ _wPMinDetWEpi_ - _wPSorpIMWEpi_ - _tPInfPO4WEpi_ / _sDepthWEpi_ + _tPDifPO4Epi_ / _sDepthWEpi_ + _tPResusPO4_ / _sDepthWEpi_ _ENDIF_;
_wPAbioAIMWEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ (- _tPSetAIMEpi_ ) / _sDepthWEpi_ + _wPSorpIMWEpi_ _ELSE_ (- _tPSetAIMEpi_ + _tPResusAIM_ ) / _sDepthWEpi_ + _wPSorpIMWEpi_ _ENDIF_;
...
_wNAbioNH4WEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wNMinDetWEpi_ - _wNNitrWEpi_ - _tNInfNH4WEpi_ / _sDepthWEpi_ + (_tNDifNH4Epi_ ) / _sDepthWEpi_ _ELSE_ _wNMinDetWEpi_ - _wNNitrWEpi_ - _tNInfNH4WEpi_ / _sDepthWEpi_ + (_tNDifNH4Epi_ + _tNResusNH4_) / _sDepthWEpi_ _ENDIF_;
_wNAbioNO3WEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wNNitrWEpi_ - _wNDenitWEpi_ + (_tNDifNO3Epi_ - _tNInfNO3WEpi_) / _sDepthWEpi_ _ELSE_ _wNNitrWEpi_ - _wNDenitWEpi_ + (_tNDifNO3Epi_ + _tNResusNO3_ - _tNInfNO3WEpi_) / _sDepthWEpi_ _ENDIF_;
_wNAbioDetWEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ - _wNMinDetWEpi_ - (_tNSetDetEpi_) / _sDepthWEpi_ _ELSE_ - _wNMinDetWEpi_ - (_tNSetDetEpi_ - _tNResusDet_ ) / _sDepthWEpi_ _ENDIF_;
...
_tNAbioTotT_ = _uNErosOM_ - _tNDenitS_ - _wNDenitWEpi_ * _sDepthWEpi_ - _wNDenitWHyp_ * _sDepthWHyp_ - _tNInfNH4S_ - _tNInfNO3S_ - _tNDifGroundNO3_ - _tNDifGroundNH4_;
_tNAbioTotW_ = (_wNAbioNH4WHyp_ + _wNAbioNO3WHyp_ + _wNAbioDetWHyp_) * _sDepthWHyp_ + (_wNAbioNH4WEpi_ +  _wNAbioNO3WEpi_ + _wNAbioDetWEpi_) * _sDepthWEpi_;
_tNAbioTotS_ = _tNAbioNH4S_ + _tNAbioNO3S_ + _tNAbioDetS_ + _tNAbioHumS_;
_wSiAbioSiO2WEpi_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_ ) _THEN_ _wSiMinDetWEpi_ + (1.0 - _fRefrDetS_) * _tSiMinDetS_ / _sDepthWEpi_ _ELSE_ _wSiMinDetWEpi_ _ENDIF_;
_wSiAbioDetWEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ - _wSiMinDetWEpi_ - (_tSiSetDetEpi_ ) / _sDepthWEpi_ _ELSE_ - _wSiMinDetWEpi_ - (_tSiSetDetEpi_ - _tSiResusDet_) / _sDepthWEpi_ _ENDIF_;
...
_wDBedDetWEpi_ = _IF_ (_InclVeg_ _EQ_ _TRUE_) _THEN_ (_tDMortVegWEpi_ + _tDEgesBird_) / _sDepthWEpi_ _ELSE_ 0.0 _ENDIF_;
_tDBedDetSEpi_ = _IF_ ( _InclVeg_ _EQ_ _TRUE_) _THEN_ _tDMortVegSEpi_ _ELSE_ 0.0 _ENDIF_;
_wPBedPO4WEpi_ = _IF_ (_InclVeg_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ (- _tPUptVegWEpi_ + _tPExcrVegW_ * _uVegHeightEpi_ / _uVegHeight_ + _tPMortVegPO4WEpi_ + _tPEgesBirdPO4_) /_sDepthWEpi_ _ENDIF_;
_wPBedDetWEpi_ = _IF_ (_InclVeg_ _EQ_ _TRUE_) _THEN_ (_tPMortVegDetWEpi_ + _tPEgesBirdDet_) / _sDepthWEpi_ _ELSE_ 0.0 _ENDIF_;
...
_wNBedNH4WEpi_ = _IF_ ( _InclVeg_ _EQ_ _TRUE_ ) _THEN_ (- _tNUptNH4VegWEpi_ + _tNExcrVegW_ * (_uVegHeightEpi_ /_uVegHeight_ ) + _tNMortVegNH4WEpi_ + _tNEgesBirdNH4_) / _sDepthWEpi_ _ELSE_ 0.0 _ENDIF_;
_wNBedNO3WEpi_ = _IF_ ( _InclVeg_ _EQ_ _TRUE_) _THEN_ - _tNUptNO3VegWEpi_ / _sDepthWEpi_ _ELSE_ 0.0 _ENDIF_;
_wNBedDetWEpi_ = _IF_ (_InclVeg_ _EQ_ _TRUE_) _THEN_ (_tNMortVegDetWEpi_ + _tNEgesBirdDet_) / _sDepthWEpi_ _ELSE_ 0.0 _ENDIF_;
...
_tNUptBlueEpi_ = _wNUptBlueEpi_ * _sDepthWEpi_;
...
_wNUptBlueWEpi_ = _tNUptBlueWEpi_ / _sDepthWEpi_;
...
_aExtChBlueEpi_ = _cExtSpBlue_ / _rChDBlueEpi_;
...
_ukDDecBlueEpi_ = _ukDRespTmBlueEpi_ + _ukLossTmBlueEpi_ + _kMortBlueW_ +(_uCorVSetBlueEpi_ * _uFunTmSetEpi_) / _sDepthWEpi_;
...
_wDPrimBlueWEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wDAssBlueEpi_ - _wDRespBlueWEpi_ - _wDLossBlueEpi_ - _wDMortBlueWEpi_ + (_tDSetBlueSurf_-_tDFloBlueEpi_ + _tDFloBlueHyp_- _tDSetBlueEpi_ ) / _sDepthWEpi_ _ELSE_ _wDAssBlueEpi_ - _wDRespBlueWEpi_ - _wDLossBlueEpi_ - _wDMortBlueWEpi_ + (_tDResusBlue_ + _tDSetBlueSurf_ - _tDSetBlueEpi_ -  _tDFloBlueEpi_) / _sDepthWEpi_ _ENDIF_;
_wPPrimBlueWEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wPUptBlueEpi_ - _wPExcrBlueWEpi_ - _wPLossBlueEpi_ - _wPMortBlueWEpi_+ (_tPSetBlueSurf_-_tPFloBlueEpi_ + _tPFloBlueHyp_- _tPSetBlueEpi_ ) / _sDepthWEpi_ _ELSE_ _wPUptBlueEpi_ - _wPExcrBlueWEpi_ - _wPLossBlueEpi_ - _wPMortBlueWEpi_+ (_tPResusBlue_ + _tPSetBlueSurf_ - _tPSetBlueEpi_ -  _tPFloBlueEpi_) / _sDepthWEpi_ _ENDIF_;
_wNPrimBlueWEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wNUptBlueEpi_ - _wNExcrBlueWEpi_ - _wNLossBlueEpi_ - _wNMortBlueWEpi_ + (_tNSetBlueSurf_-_tNFloBlueEpi_ + _tNFloBlueHyp_- _tNSetBlueEpi_ ) / _sDepthWEpi_ _ELSE_ _wNUptBlueEpi_ - _wNExcrBlueWEpi_ - _wNLossBlueEpi_ - _wNMortBlueWEpi_+ (_tNResusBlue_ + _tNSetBlueSurf_ - _tNSetBlueEpi_ -  _tNFloBlueEpi_) / _sDepthWEpi_ _ENDIF_;
...
_aNutLimBlueSurf_ = _MIN_(_aPLimBlueSurf_,_MIN_(_aNLimBlueSurf_,_aSiLimBlueSurf_));
...
_wNMortBlueNH4WSurf_ = _fDissMortPhyt_ * _tNMortBlueSurf_ / _sDepthWEpi_;
_wNMortBlueDetSurf_ = ( 1 -_fDissMortPhyt_) * _tNMortBlueSurf_ / _sDepthWEpi_;
...
_aLLimGrenEpi_ = _UseSteeleGren_ *(_EXP_(1.0) /(_aExtCoefEpi_ * _sDepthWEpi_) *(_EXP_(- _aLPARBotEpi_ /(_cLOptRefGren_ * _uFunTmProdGrenEpi_)) - _EXP_(- _aLPARBotSurf_ /(_cLOptRefGren_ * _uFunTmProdGrenEpi_)))) +(1.0 - _UseSteeleGren_) *(1.0 /(_aExtCoefEpi_ * _sDepthWEpi_) * _LN_((1.0 + _aLPARBotSurf_ / (_hLRefGren_ * _uFunTmProdGrenEpi_)) / (1.0 + _aLPARBotEpi_ /(_hLRefGren_ * _uFunTmProdGrenEpi_))));
...
_ukDDecGrenEpi_ = _ukDRespTmGrenEpi_ + _ukLossTmGrenEpi_ + _kMortGrenW_ +(_uCorVSetGrenEpi_ * _uFunTmSetEpi_) / _sDepthWEpi_;
...
_wDPrimGrenWEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wDAssGrenEpi_ - _wDRespGrenWEpi_ - _wDLossGrenEpi_ - _wDMortGrenWEpi_ -(_tDSetGrenEpi_ ) / _sDepthWEpi_ _ELSE_ _wDAssGrenEpi_ - _wDRespGrenWEpi_ - _wDLossGrenEpi_ - _wDMortGrenWEpi_ -(_tDSetGrenEpi_ - _tDResusGren_) / _sDepthWEpi_ _ENDIF_;
_wPPrimGrenWEpi_ =_IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wPUptGrenEpi_ - _wPExcrGrenWEpi_ - _wPLossGrenEpi_ - _wPMortGrenWEpi_ -(_tPSetGrenEpi_ ) / _sDepthWEpi_ _ELSE_ _wPUptGrenEpi_ - _wPExcrGrenWEpi_ - _wPLossGrenEpi_ - _wPMortGrenWEpi_ -(_tPSetGrenEpi_ - _tPResusGren_) / _sDepthWEpi_ _ENDIF_;
_wNPrimGrenWEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wNUptGrenEpi_ - _wNExcrGrenWEpi_ - _wNLossGrenEpi_ - _wNMortGrenWEpi_ -(_tNSetGrenEpi_ ) / _sDepthWEpi_ _ELSE_ _wNUptGrenEpi_ - _wNExcrGrenWEpi_ - _wNLossGrenEpi_ - _wNMortGrenWEpi_ -(_tNSetGrenEpi_ - _tNResusGren_) / _sDepthWEpi_ _ENDIF_;
...
_aLLimDiatEpi_ = _UseSteeleDiat_ *(_EXP_(1.0) /(_aExtCoefEpi_ * _sDepthWEpi_) *(_EXP_(- _aLPARBotEpi_ /(_cLOptRefDiat_ * _uFunTmProdDiatEpi_)) - _EXP_(- _aLPARBotSurf_ /(_cLOptRefDiat_ * _uFunTmProdDiatEpi_)))) +(1.0 - _UseSteeleDiat_) *(1.0 /(_aExtCoefEpi_ * _sDepthWEpi_) * _LN_((1.0 + _aLPARBotSurf_ / (_hLRefDiat_ * _uFunTmProdDiatEpi_)) / (1.0 + _aLPARBotEpi_ /(_hLRefDiat_ * _uFunTmProdDiatEpi_))));
...
_ukDDecDiatEpi_ = _ukDRespTmDiatEpi_ + _ukLossTmDiatEpi_ + _kMortDiatW_ +(_uCorVSetDiatEpi_ * _uFunTmSetEpi_) / _sDepthWEpi_;
...
_wDPrimDiatWEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wDAssDiatEpi_ - _wDRespDiatWEpi_ - _wDLossDiatEpi_ - _wDMortDiatWEpi_ -(_tDSetDiatEpi_ ) / _sDepthWEpi_ _ELSE_ _wDAssDiatEpi_ - _wDRespDiatWEpi_ - _wDLossDiatEpi_ - _wDMortDiatWEpi_ -(_tDSetDiatEpi_ - _tDResusDiat_) / _sDepthWEpi_ _ENDIF_;
_wPPrimDiatWEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wPUptDiatEpi_ - _wPExcrDiatWEpi_ - _wPLossDiatEpi_ - _wPMortDiatWEpi_ -(_tPSetDiatEpi_ ) / _sDepthWEpi_ _ELSE_ _wPUptDiatEpi_ - _wPExcrDiatWEpi_ - _wPLossDiatEpi_ - _wPMortDiatWEpi_ -(_tPSetDiatEpi_ - _tPResusDiat_) / _sDepthWEpi_ _ENDIF_;
_wNPrimDiatWEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wNUptDiatEpi_ - _wNExcrDiatWEpi_ - _wNLossDiatEpi_ - _wNMortDiatWEpi_ -(_tNSetDiatEpi_ ) / _sDepthWEpi_ _ELSE_ _wNUptDiatEpi_ - _wNExcrDiatWEpi_ - _wNLossDiatEpi_ - _wNMortDiatWEpi_ -(_tNSetDiatEpi_ - _tNResusDiat_) / _sDepthWEpi_ _ENDIF_;
...
_oChla_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ (_oChlaEpi_ * _sDepthWEpi_ + _oChlaHyp_ * _sDepthWHyp_ + _aChlaBlueSurf_) / _uDepthW_ _ELSE_ (_oChlaEpi_ * _sDepthWEpi_+ _aChlaBlueSurf_ ) / _uDepthW_ _ENDIF_;
_oChlaW_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ (_oChlaEpi_ * _sDepthWEpi_ + _oChlaHyp_ * _sDepthWHyp_) / _uDepthW_ _ELSE_ (_oChlaEpi_ * _sDepthWEpi_) / _uDepthW_ _ENDIF_;
_aChlaH_ = _oChla_ * _uDepthW_;
_aLPIEpi_ =  (_aLPARBotSurf_- _aLPARBotEpiOpen_ + _uhLVeg_* _LN_((1.0 +_aLPARBotEpiOpen_/ _uhLVeg_)  /(1.0 + _aLPARBotSurf_  / _uhLVeg_) + _NearZero_  ) ) / _sDepthWEpi_;
_aLPIHyp_ =  (_aLPARBotEpi_- _aLPARBotHypOpen_ + _uhLVeg_* _LN_((1.0 +_aLPARBotHypOpen_/ _uhLVeg_)  /(1.0 + _aLPARBotEpi_  / _uhLVeg_) + _NearZero_  ) ) / _sDepthWHyp_;
_aLMeasEpi_ = _aLPARBotSurf_ * _EXP_(- _aExtCoefOpenEpi_ *_cDepthMeasoChl_);
_aLMeasHyp_ = _aLPARBotEpi_ * _EXP_(- _aExtCoefOpenHyp_ * (_cDepthMeasoChl_ -  _sDepthWEpi_));
_aLPAREupho_ = _PerCent_ * _uLPARSurf_;
_oChlaMeasEpi_ = (_aLMeasEpi_  )/ _aLPIEpi_ *_oChlaEpi_;
_oChlaMeasHyp_ =  (_aLMeasHyp_  )/ _aLPIHyp_ *_oChlaHyp_;
_oChlaMeasW_ = _IF_ (_aLPARBotSurf_ _LT_ _aLPAREupho_) _THEN_ (_IF_ (_cDepthMeasoChl_ _LT_ _sDepthWEpi_) _THEN_ _oChlaEpi_ _ELSE_ _oChlaHyp_ _ENDIF_) _ELSE_ (_IF_ (_cDepthMeasoChl_ _LT_ _sDepthWEpi_) _THEN_ _oChlaMeasEpi_ _ELSE_ _oChlaMeasHyp_ _ENDIF_) _ENDIF_;
...
_wDLossPhytEpi_ = _wDLossDiatEpi_ + _wDLossGrenEpi_ + _wDLossBlueEpi_ + _tDLossBlueSurf_ / _sDepthWEpi_;
...
_wPLossPhytEpi_ = _wPLossDiatEpi_ + _wPLossGrenEpi_ + _wPLossBlueEpi_ + _tPLossBlueSurf_ / _sDepthWEpi_;
...
_wNLossPhytEpi_ = _wNLossDiatEpi_ + _wNLossGrenEpi_ + _wNLossBlueEpi_ + _tNLossBlueSurf_ / _sDepthWEpi_;
...
_wSiPrimDiatWHyp_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wSiUptDiatHyp_ - _tSiSetDiatHyp_ / _sDepthWHyp_ - _wSiExcrDiatWHyp_ - _wSiMortDiatWHyp_ - _wSiLossDiatHyp_ _ELSE_ 0.0 _ENDIF_;
_wSiPrimDiatWEpi_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_ ) _THEN_ _wSiUptDiatEpi_ - _tSiSetDiatEpi_ / _sDepthWEpi_ - _wSiExcrDiatWEpi_ - _wSiMortDiatWEpi_ - _wSiLossDiatEpi_ _ELSE_ _wSiUptDiatEpi_ - _tSiSetDiatEpi_ / _sDepthWEpi_ - _wSiExcrDiatWEpi_ - _wSiMortDiatWEpi_ - _wSiLossDiatEpi_ + _tSiResusDiat_ / _sDepthWEpi_ _ENDIF_;
...
_wDPrimDetWEpi_ = _IF_ (_InclSurf_ _EQ_ _TRUE_) _THEN_ _wDMortPhytWEpi_ + _wDLossPhytEpi_ + _tDMortBlueSurf_ / _sDepthWEpi_ _ELSE_ _wDMortPhytWEpi_ + _wDLossPhytEpi_ _ENDIF_;
_tDPrimDetS_ = _tDMortPhytS_;
_tDPrimTotW_ = (_wDPrimDetWHyp_ + _wDPrimDiatWHyp_ + _wDPrimGrenWHyp_+ _wDPrimBlueWHyp_) * _sDepthWHyp_+ (_wDPrimDetWEpi_ + _wDPrimDiatWEpi_ + _wDPrimGrenWEpi_+ _wDPrimBlueWEpi_) * _sDepthWEpi_;
_tDPrimTotWEpi_ = (_wDPrimDetWEpi_ + _wDPrimDiatWEpi_ + _wDPrimGrenWEpi_ + _wDPrimBlueWEpi_) * _sDepthWEpi_;
_tDPrimTotWHyp_ = (_wDPrimDetWHyp_ + _wDPrimDiatWHyp_ + _wDPrimGrenWHyp_ + _wDPrimBlueWHyp_) * _sDepthWHyp_;
_tDPrimTotS_ = _tDPrimDetS_ + _tDPrimDiatS_ + _tDPrimGrenS_ + _tDPrimBlueS_;
_tDPrimTotSurf_ = _IF_ (_InclSurf_ _EQ_ _TRUE_) _THEN_ _tDAssBlueSurf_ - _tDRespBlueSurf_ _ELSE_ 0.0 _ENDIF_;
_tDPrimTotT_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_ ) _THEN_(_wDAssPhytEpi_ - _wDRespPhytWEpi_) * _sDepthWEpi_ - _tDRespPhytS_ + _tDPrimTotSurf_ _ELSE_ (_wDAssPhytEpi_ - _wDRespPhytWEpi_) * _sDepthWEpi_ + (_wDAssPhytHyp_ - _wDRespPhytWHyp_) * _sDepthWHyp_ - _tDRespPhytS_ + _tDPrimTotSurf_ _ENDIF_;
...
_tO2PrimSHyp_ = _IF_ _aInclStrat_ _EQ_ _TRUE_ _THEN_ _tO2PrimS_ / _sDepthWHyp_ _ELSE_ 0.0 _ENDIF_;
_tO2PrimSEpi_ = _IF_ _aInclStrat_ _EQ_ _FALSE_ _THEN_ _tO2PrimS_ / _sDepthWEpi_ _ELSE_ 0.0 _ENDIF_;
_wPMortBluePO4WSurf_ = _fDissMortPhyt_ * _tPMortBlueSurf_ / _sDepthWEpi_;
_wPMortBlueDetSurf_ = ( 1 -_fDissMortPhyt_) * _tPMortBlueSurf_ / _sDepthWEpi_;
...
_wPPrimPO4WEpi_ = - _wPUptPhytEpi_ + _wPExcrPhytWEpi_ + _wPLossPhytPO4Epi_ + _wPMortPhytPO4WEpi_ - _tPUptBlueSurf_ / _sDepthWEpi_ + _tPExcrBlueSurf_ / _sDepthWEpi_ + _wPMortBluePO4WSurf_;
...
_wNPrimNH4WEpi_ = - _wNUptNH4PhytEpi_ + _wNExcrPhytWEpi_ + _wNLossPhytNH4Epi_ + _wNMortPhytNH4WEpi_- _tNUptNH4BlueSurf_ / _sDepthWEpi_ + _tNExcrBlueSurf_ / _sDepthWEpi_ + _wNMortBlueNH4WSurf_;
_wNPrimNO3WEpi_ = - _wNUptNO3PhytEpi_ - _tNUptNO3BlueSurf_ / _sDepthWEpi_;
_wNPrimDetWEpi_ = _wNLossPhytDetEpi_ + _wNMortPhytDetWEpi_;
_tNPrimDetS_ = _tNMortPhytDetS_ ;
_tNPrimTotW_ = (_wNPrimNH4WHyp_ + _wNPrimNO3WHyp_ + _wNPrimDetWHyp_ +  _wNPrimDiatWHyp_ + _wNPrimGrenWHyp_ + _wNPrimBlueWHyp_)* _sDepthWHyp_ + (_wNPrimNH4WEpi_ + _wNPrimNO3WEpi_ + _wNPrimDetWEpi_+ _wNPrimDiatWEpi_ + _wNPrimGrenWEpi_ + _wNPrimBlueWEpi_) * _sDepthWEpi_;
_tNPrimTotS_ = _tNPrimNH4S_ + _tNPrimNO3S_ + _tNPrimDetS_ + _tNPrimDiatS_ + _tNPrimGrenS_ + _tNPrimBlueS_;
_wSiPrimSiO2WEpi_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ _wSiExcrDiatWEpi_ - _wSiUptDiatEpi_ + _tSiExcrDiatS_ / _sDepthWEpi_ _ELSE_ _wSiExcrDiatWEpi_ - _wSiUptDiatEpi_ _ENDIF_;
...
_aRelDepthEuphEpi_ = _aDepthEuphEpi_ / _sDepthWEpi_;
_aChlaHEpi_ = _oChlaEpi_ * _sDepthWEpi_;
_aCovPhytWEpi_ = _cCovSpPhyt_ *(_oDPhytWEpi_ * _sDepthWEpi_);
...
_oDFoodZooEpi_ = _aDFoodZooEpi_ / _sDepthWEpi_;
...
_tDConsBlueZooSurf_ =  _IF_ (_InclSurf_ _EQ_ _FALSE_ _OR_ _sDBlueSurf_ _LT_ _cDBlueSurfMin_) _THEN_ 0.0 _ELSE_ _wDConsBlueZooSurf_ *_sDepthWEpi_ _ENDIF_;
...
_tPConsBlueZooSurf_ = _wPConsBlueZooSurf_ *_sDepthWEpi_;
...
_tNConsBlueZooSurf_ = _wNConsBlueZooSurf_ *_sDepthWEpi_;
...
_tDReprFish_ = _IF_ (_FALSE_ _EQ_ _InclSeason_) _THEN_ ((1/_DaysInYear_)*_fReprFish_) * _sDFiAd_ _ELSEIF_ (_Day_ _GE_ _cDayReprFish_ _AND_ _Day_ _LT_ _cDayReprFish_ + 1.0) _THEN_ _fReprFish_ * _sDFiAd_ * _PerDay_ _ELSE_ 0.0 _ENDIF_;
_tDAgeFish_ = _IF_ (_FALSE_ _EQ_ _InclSeason_) _THEN_ ((1/_DaysInYear_)*_fAgeFish_) * _sDFiJv_ _ELSEIF_ (_Day_ _GE_ 364.0) _THEN_ _fAgeFish_ * _sDFiJv_ *_PerDay_ _ELSE_ 0.0 _ENDIF_;
_aDTotZoo_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ _oDZooEpi_ * _sDepthWEpi_ _ELSE_ _oDZooEpi_ * _sDepthWEpi_ + _oDZooHyp_ * _sDepthWHyp_ _ENDIF_;
_aPTotZoo_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ _oPZooEpi_ * _sDepthWEpi_ _ELSE_ _oPZooEpi_ * _sDepthWEpi_ + _oPZooHyp_ * _sDepthWHyp_ _ENDIF_;
_aNTotZoo_ = _IF_ (_aInclStrat_ _EQ_ _FALSE_) _THEN_ _oNZooEpi_ * _sDepthWEpi_ _ELSE_ _oNZooEpi_ * _sDepthWEpi_ + _oNZooHyp_ * _sDepthWHyp_ _ENDIF_;
...
_tNWebTotS_ = _tNWebNH4S_ + _tNWebNO3S_ + _tNWebDetS_ + _tNWebDiatS_ + _tNWebGrenS_ + _tNWebBlueS_ + _tNWebBent_ ;
_tDWebFiJv_ = _IF_ (_FALSE_ _EQ_ _InclWeb_) _THEN_ 0.0 _ELSE_ _tDMigrFiJv_ + _tDReprFish_ - _tDAgeFish_ + _tDAssFiJv_ - _tDRespFiJv_ - _tDMortFiJv_ - _tDConsFiJvPisc_ _ENDIF_;
_tPWebFiJv_ = _IF_ (_FALSE_ _EQ_ _InclWeb_) _THEN_ 0.0 _ELSE_ _tPMigrFiJv_ + _tPReprFish_ - _tPAgeFish_ + _tPAssFiJv_ - _tPExcrFiJv_ - _tPMortFiJv_ - _tPConsFiJvPisc_ _ENDIF_;
_tNWebFiJv_ =_IF_ (_FALSE_ _EQ_ _InclWeb_) _THEN_ 0.0 _ELSE_ _tNMigrFiJv_ + _tNReprFish_ - _tNAgeFish_ + _tNAssFiJv_ - _tNExcrFiJv_ - _tNMortFiJv_ - _tNConsFiJvPisc_ _ENDIF_;
_tDWebFiAd_ = _IF_ (_FALSE_ _EQ_ _InclWeb_) _THEN_ 0.0 _ELSE_ _tDMigrFiAd_ + _tDAssFiAd_ - _tDRespFiAd_ - _tDMortFiAd_ - _tDReprFish_ + _tDAgeFish_ - _tDConsFiAdPisc_ - _tDHarvFish_ _ENDIF_;
_tPWebFiAd_ = _IF_ (_FALSE_ _EQ_ _InclWeb_) _THEN_ 0.0 _ELSE_ _tPMigrFiAd_ + _tPAssFiAd_ - _tPExcrFiAd_ - _tPMortFiAd_ - _tPReprFish_ + _tPAgeFish_ - _tPConsFiAdPisc_ - _tPHarvFish_ _ENDIF_;
_tNWebFiAd_ = _IF_ (_FALSE_ _EQ_ _InclWeb_) _THEN_ 0.0 _ELSE_ _tNMigrFiAd_ + _tNAssFiAd_ - _tNExcrFiAd_ - _tNMortFiAd_ - _tNReprFish_ + _tNAgeFish_ - _tNConsFiAdPisc_ - _tNHarvFish_ _ENDIF_;
...
_wDWebZooHyp_ = _IF_ (_FALSE_ _EQ_ _InclWeb_ _OR_ _aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wDAssZooHyp_ - _wDRespZooHyp_ - _wDMortZooHyp_ - _tDConsFiJv_ * (( _aDTotZoo_ - _oDZooEpi_ * _sDepthWEpi_) / (_aDTotZoo_ + _NearZero_)) / _sDepthWHyp_ _ENDIF_;
_wDWebDetWHyp_ = _IF_ (_FALSE_ _EQ_ _InclWeb_) _THEN_ 0.0 _ELSE_ - _wDConsDetZooHyp_ + _wDEgesZooHyp_ + _wDMortZooHyp_ +(_tDEgesFiJv_ * _uFiJvEgesHyp_ + _tDEgesFiAd_ * _uFiAdEgesHyp_ + _tDMortFiJvDet_ * _uFiJvMortHyp_ + _tDMortFiAdDet_ * _uFiAdMortHyp_ + _tDEgesPisc_ * _uPiscEgesHyp_ + _tDMortPiscDet_ * _uPiscMortHyp_) / _sDepthWHyp_ _ENDIF_;
...
_wDWebZooEpi_ = _IF_ (_FALSE_ _EQ_ _InclWeb_) _THEN_ 0.0 _ELSE_ _wDAssZooEpi_ - _wDRespZooEpi_ - _wDMortZooEpi_ - _tDConsFiJv_ * (_oDZooEpi_ * _sDepthWEpi_ / (_aDTotZoo_ + _NearZero_) ) / _sDepthWEpi_ _ENDIF_;
_wDWebDetWEpi_ = _IF_ (_FALSE_ _EQ_ _InclWeb_) _THEN_ 0.0 _ELSE_ - _wDConsDetZooEpi_ + _wDEgesZooEpi_ + _wDMortZooEpi_ +(_tDEgesFiJv_ * ( 1.0 - _uFiJvEgesHyp_ ) + _tDEgesFiAd_ * ( 1.0 - _uFiAdEgesHyp_ ) + _tDMortFiJvDet_ * ( 1.0 - _uFiJvMortHyp_ ) + _tDMortFiAdDet_ * ( 1.0 - _uFiAdMortHyp_ ) + _tDEgesPisc_ * ( 1.0 - _uPiscEgesHyp_ ) + _tDMortPiscDet_ * ( 1.0 - _uPiscMortHyp_)) / _sDepthWEpi_ _ENDIF_;
...
_tDWebTotW_ = (_wDWebDetWHyp_ + _wDWebDiatWHyp_ + _wDWebGrenWHyp_ + _wDWebBlueWHyp_ + _wDWebZooHyp_) *_sDepthWHyp_ + (_wDWebDetWEpi_ + _wDWebDiatWEpi_ + _wDWebGrenWEpi_ + _wDWebBlueWEpi_ + _wDWebZooEpi_) *_sDepthWEpi_ + _tDWebFiAd_ + _tDWebFiJv_ + _tDWebPisc_ ;
_tDWebTotWEpi_ = (_wDWebDetWEpi_ + _wDWebDiatWEpi_ + _wDWebGrenWEpi_ + _wDWebBlueWEpi_ + _wDWebZooEpi_) * _sDepthWEpi_;
_tDWebTotWHyp_ = (_wDWebDetWHyp_ + _wDWebDiatWHyp_ + _wDWebGrenWHyp_ + _wDWebBlueWHyp_ + _wDWebZooHyp_) * _sDepthWHyp_;
_tDWebTotS_ = _tDWebDetS_ + _tDWebDiatS_ + _tDWebGrenS_ + _tDWebBlueS_ + _tDWebBent_;
_tDWebTotT_ = _IF_ (_FALSE_ _EQ_ _InclWeb_) _THEN_ 0.0 _ELSE_ - _wDRespZooEpi_ * _sDepthWEpi_ + - _wDRespZooHyp_ * _sDepthWHyp_ + _tDMigrFiJv_ + _tDMigrFiAd_ + _tDMigrPisc_ + _tDMigrBent_ - _tDRespFiJv_ - _tDRespFiAd_ - _tDRespPisc_ - _tDRespBent_ - _tDMortFiJvBot_ - _tDMortFiAdBot_- _tDMortPiscBot_ - _tDHarvFish_ - _tDHarvPisc_ _ENDIF_;
_wPWebZooHyp_ = _IF_ (_FALSE_ _EQ_ _InclWeb_ _OR_ _aInclStrat_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSE_ _wPAssZooHyp_ - _wPExcrZooHyp_ - _wPMortZooHyp_ - _tPConsFiJv_ * (( _aPTotZoo_ - _oPZooEpi_ * _sDepthWEpi_ ) / (_aPTotZoo_ + _NearZero_) ) / _sDepthWHyp_ _ENDIF_;
_wPWebPO4WHyp_ = _IF_ (_FALSE_ _EQ_ _InclWeb_) _THEN_ 0.0 _ELSE_ _wPExcrZooHyp_ + _wPEgesZooPO4Hyp_ + _wPMortZooPO4Hyp_ +(_tPExcrFiJv_ *_uFiJvExcrHyp_ + _tPExcrFiAd_ * _uFiAdExcrHyp_ + _tPEgesFiJvPO4_ * _uFiJvEgesHyp_ + _tPEgesFiAdPO4_ * _uFiAdEgesHyp_ + _tPMortFiJvPO4_ * _uFiJvMortHyp_ + _tPMortFiAdPO4_ * _uFiAdMortHyp_+ _tPExcrPisc_ * _uPiscExcrHyp_ + _tPEgesPiscPO4_ * _uPiscEgesHyp_ + _tPMortPiscPO4_ * _uPiscMortHyp_ ) / _sDepthWHyp_ _ENDIF_;
_wPWebDetWHyp_ = _IF_ (_FALSE_ _EQ_ _InclWeb_) _THEN_ 0.0 _ELSE_ - _wPConsDetZooHyp_ + _wPEgesZooDetHyp_ + _wPMortZooDetHyp_ +(_tPEgesFiJvDet_ * _uFiJvEgesHyp_ + _tPEgesFiAdDet_ * _uFiAdEgesHyp_+ _tPMortFiJvDet_ * _uFiJvMortHyp_ + _tPMortFiAdDet_ * _uFiAdMortHyp_+ _tPEgesPiscDet_ * _uPiscEgesHyp_+ _tPMortPiscDet_ * _uPiscMortHyp_) / _sDepthWHyp_ _ENDIF_;
...
_wNWebZooEpi_ = _IF_ (_FALSE_ _EQ_ _InclWeb_) _THEN_ 0.0 _ELSE_ _wNAssZooEpi_ - _wNExcrZooEpi_ - _wNMortZooEpi_ - _tNConsFiJv_ * (_oNZooEpi_ * _sDepthWEpi_ / (_aNTotZoo_ + _NearZero_) ) / _sDepthWEpi_ _ENDIF_;
_wNWebNH4WEpi_ = _IF_ (_FALSE_ _EQ_ _InclWeb_) _THEN_ 0.0 _ELSE_ _wNExcrZooEpi_ + _wNEgesZooNH4Epi_ + _wNMortZooNH4Epi_ +(_tNExcrFiJv_ * ( 1.0 - _uFiJvExcrHyp_) + _tNExcrFiAd_ * ( 1.0 - _uFiAdExcrHyp_) + _tNEgesFiJvNH4_ * ( 1.0 - _uFiJvEgesHyp_ ) + _tNEgesFiAdNH4_ * ( 1.0 - _uFiAdEgesHyp_ ) + _tNMortFiAdNH4_ * ( 1.0 -_uFiAdMortHyp_ ) + _tNMortFiJvNH4_* ( 1.0 -_uFiJvMortHyp_) + _tNExcrPisc_ * ( 1.0 -_uPiscExcrHyp_ ) + _tNEgesPiscNH4_ * ( 1.0 -_uPiscEgesHyp_ ) + _tNMortPiscNH4_ * ( 1.0 -_uPiscMortHyp_)) / _sDepthWEpi_ _ENDIF_;
_wNWebDetWEpi_ = _IF_ (_FALSE_ _EQ_ _InclWeb_) _THEN_ 0.0 _ELSE_ - _wNConsDetZooEpi_ + _wNEgesZooDetEpi_ + _wNMortZooDetEpi_ +(_tNEgesFiJvDet_ * ( 1.0 - _uFiJvEgesHyp_ ) +_tNEgesFiAdDet_ * ( 1.0 - _uFiAdEgesHyp_ ) + _tNMortFiJvDet_ * ( 1.0 - _uFiJvMortHyp_ ) + _tNMortFiAdDet_ * ( 1.0 - _uFiAdMortHyp_ ) + _tNEgesPiscDet_ * ( 1.0 - _uPiscEgesHyp_ ) + _tNMortPiscDet_ * ( 1.0 - _uPiscMortHyp_ )) / _sDepthWEpi_ _ENDIF_;
...
_tNWebTotW_ = (_wNWebNH4WHyp_ + _wNWebNO3WHyp_ + _wNWebDetWHyp_ + _wNWebDiatWHyp_ + _wNWebGrenWHyp_ + _wNWebBlueWHyp_ + _wNWebZooHyp_) * _sDepthWHyp_ + (_wNWebNH4WEpi_  + _wNWebNO3WEpi_ + _wNWebDetWEpi_ + _wNWebDiatWEpi_ + _wNWebGrenWEpi_ + _wNWebBlueWEpi_ + _wNWebZooEpi_) * _sDepthWEpi_ + _tNWebFiAd_ + _tNWebFiJv_;
...
_tDDredNetTotW_ =_tDDredVeg_;
_tNDredNetTotW_ = _tNDredVeg_;
_tDDredNetTotS_ = _tDDredNetIMS_ + _tDDredNetHumS_ + _tDDredDetS_ + _tDDredDiatS_ + _tDDredGrenS_ + _tDDredBlueS_ + _tDDredBent_;
_tNDredNetTotS_ =  _tNDredDetS_ + _tNDredNetHumS_ + _tNDredDiatS_ + _tPDredGrenS_ + _tNDredBlueS_ + _tNDredBent_;
...
_tDBurIM_ = _IF_ (_InclBur_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSEIF_ (_vDeltaS_ _GE_ 0.0) _THEN_ ((_tDHumS_ + _tDDetS_) +(_cRhoOM_ / _cRhoIM_) * _tDIMS_) / ((_sDHumS_ + _sDDetS_) / _sDIMS_ + _cRhoOM_ / _cRhoIM_) _ELSE_ ((_tDHumS_ + _tDDetS_) +(_cRhoOM_ / _cRhoIM_) * _tDIMS_) / (_fDOrgSoil_ /(1.0 - _fDOrgSoil_) + _cRhoOM_ / _cRhoIM_) _ENDIF_;
_tDBurOM_ = _IF_ (_InclBur_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSEIF_ (_vDeltaS_ _GE_ 0.0) _THEN_ (_sDHumS_ + _sDDetS_) / _sDIMS_ * _tDBurIM_ _ELSE_ _fDOrgSoil_ /(1.0 - _fDOrgSoil_) * _tDBurIM_ _ENDIF_;
_tDBurDet_ = _IF_ (_InclBur_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSEIF_ (_vDeltaS_ _GE_ 0.0) _THEN_ _sDDetS_ /(_sDHumS_ + _sDDetS_) * _tDBurOM_ _ELSE_ 0.0 _ENDIF_;
...
_tPBurAIM_ = _IF_ (_InclBur_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSEIF_ (_vDeltaS_ _GE_ 0.0) _THEN_ _sPAIMS_ / _sDIMS_ * _tDBurIM_ _ELSE_ 0.0 _ENDIF_;
_tPBurPO4_ = _IF_ (_InclBur_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSEIF_ (_vDeltaS_ _GE_ 0.0) _THEN_ _sPO4S_ *(_vDeltaS_ / _cDepthS_) _ELSE_ _cPO4Ground_ *(_bPorS_ * _vDeltaS_) _ENDIF_;
...
_tNBurNH4_ = _IF_ (_InclBur_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSEIF_ (_vDeltaS_ _GE_ 0.0) _THEN_ _sNH4S_ *(_vDeltaS_ / _cDepthS_) _ELSE_ _cNH4Ground_ *(_bPorS_ * _vDeltaS_) _ENDIF_;
_tNBurNO3_ = _IF_ (_InclBur_ _EQ_ _FALSE_) _THEN_ 0.0 _ELSEIF_ (_vDeltaS_ _GE_ 0.0) _THEN_ _sNO3S_ *(_vDeltaS_ / _cDepthS_) _ELSE_ _cNO3Ground_ *(_bPorS_ * _vDeltaS_) _ENDIF_;
...
_aRelDeltaWEpi_ = _IF_ ( _aInclStrat_ _EQ_ _TRUE_ ) _THEN_ (_vDeltaW_ ) / _sDepthWEpi_ _ELSE_ (_vDeltaW_ + _vDredDepthW_) / _sDepthWEpi_ _ENDIF_;
_aRelDeltaWHyp_ = _IF_ ( _aInclStrat_ _EQ_ _FALSE_ ) _THEN_ 0.0 _ELSE_ (_vDredDepthW_) / _sDepthWHyp_ _ENDIF_ ;
_aPFish_ = _sPFiJv_ + _sPFiAd_;
_aNFish_ = _sNFiJv_ + _sNFiAd_;
_aDRelTotW_ = - (_sDepthWHyp_ * _aRelDeltaWHyp_ * ( _oDDetWHyp_ + _oDIMWHyp_ + _oDDiatWHyp_ + _oDGrenWHyp_ + _oDBlueWHyp_ + _oDZooHyp_ ) + _sDepthWEpi_ * _aRelDeltaWEpi_ * (_oDDetWEpi_ + _oDIMWEpi_ + _oDDiatWEpi_ + _oDGrenWEpi_ + _oDBlueWEpi_ + _oDZooEpi_ ));
_aDRelTotWEpi_ = _aRelDeltaWEpi_ * (_oDIMWEpi_ + _oDDetWEpi_ + _oDDiatWEpi_ + _oDGrenWEpi_ + _oDBlueWEpi_+ _oDZooEpi_) * _sDepthWEpi_;
_aDRelTotWHyp_ = _aRelDeltaWHyp_ * (_oDIMWHyp_ + _oDDetWHyp_ + _oDDiatWHyp_ + _oDGrenWHyp_ + _oDBlueWHyp_+ _oDZooHyp_) * _sDepthWHyp_;
_aNRelTotW_= _aRelDeltaWHyp_ * (_oNH4WHyp_ + _oNO3WHyp_ + _oNDetWHyp_ +  _oNDiatWHyp_ + _oNGrenWHyp_ + _oNBlueWHyp_ + _oNZooHyp_) * _sDepthWHyp_ + _aRelDeltaWEpi_ * (_oNH4WEpi_ + _oNO3WEpi_ + _oNDetWEpi_ + _oNDiatWEpi_ + _oNGrenWEpi_ + _oNBlueWEpi_ + _oNZooEpi_) * _sDepthWEpi_;
_aDRelTotT_ = _sDepthWHyp_ * _aRelDeltaWHyp_ * ( _oDDetWHyp_ + _oDIMWHyp_ + _oDDiatWHyp_ + _oDGrenWHyp_ + _oDBlueWHyp_ + _oDZooHyp_ ) + _fMarsh_ * _sDepthWM_ * _aRelDeltaWM_ * ( _oDDetWM_ + _oDIMWM_ + _oDDiatWM_ + _oDGrenWM_ + _oDBlueWM_ + _oDZooM_) + _sDepthWEpi_ * _aRelDeltaWEpi_ * (_oDDetWEpi_ + _oDIMWEpi_ + _oDDiatWEpi_ + _oDGrenWEpi_ + _oDBlueWEpi_ + _oDZooEpi_ );
_aNRelTotT_ = _sDepthWHyp_ * _aRelDeltaWHyp_ * ( _oNH4WHyp_ + _oNO3WHyp_ + _oNDetWHyp_ + _oNDiatWHyp_ + _oNGrenWHyp_ + _oNBlueWHyp_ + _oNZooHyp_ ) + _fMarsh_ * _sDepthWM_ * _aRelDeltaWM_ * ( _oNH4WM_ + _oNO3WM_ + _oNDetWM_ + _oNDiatWM_ + _oNGrenWM_ + _oNBlueWM_ + _oNZooM_ ) + _sDepthWEpi_ * _aRelDeltaWEpi_ * ( _oNH4WEpi_ + _oNO3WEpi_ + _oNDetWEpi_ + _oNDiatWEpi_ + _oNGrenWEpi_ + _oNBlueWEpi_ + _oNZooEpi_ );
_aPRelTotT_ = _sDepthWHyp_ * _aRelDeltaWHyp_ * ( _oPO4WHyp_ + _oPAIMWHyp_ + _oPDetWHyp_ + _oPDiatWHyp_ + _oPGrenWHyp_ + _oPBlueWHyp_ + _oPZooHyp_ ) + _fMarsh_ * _sDepthWM_ * _aRelDeltaWM_ * (_oPO4WM_ + _oPAIMWM_ + _oPDetWM_ + _oPDiatWM_ + _oPGrenWM_ + _oPBlueWM_ + _oPZooM_ ) + _sDepthWEpi_ * _aRelDeltaWEpi_ * (_oPO4WEpi_ + _oPAIMWEpi_ + _oPDetWEpi_ + _oPDiatWEpi_ + _oPGrenWEpi_ + _oPBlueWEpi_ + _oPZooEpi_ );
_aSiRelTotT_ = _sDepthWHyp_ * _aRelDeltaWHyp_ * ( _oSiO2WHyp_ + _oSiDetWHyp_ + _cSiDDiat_*_oDDiatWHyp_) + _fMarsh_ * _sDepthWM_ * _aRelDeltaWM_ * ( _oSiO2WM_ + _oSiDetWM_ + _cSiDDiat_*_oDDiatWM_) + _sDepthWEpi_ * _aRelDeltaWEpi_ * ( _oSiO2WEpi_ + _oSiDetWEpi_ + _cSiDDiat_*_oDDiatWEpi_);
_aO2RelTotT_ = _sDepthWHyp_ * _aRelDeltaWHyp_* _oO2WHyp_ + _fMarsh_ * _sDepthWM_ * _aRelDeltaWM_ * _oO2WM_ + _sDepthWEpi_ * _aRelDeltaWEpi_ * _oO2WEpi_ ;
_aDTotTHyp_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_) _THEN_ (_oDIMWHyp_+_oDDetWHyp_+_oDDiatWHyp_+_oDGrenWHyp_+_oDBlueWHyp_+_oDZooHyp_) * _sDepthWHyp_ _ELSE_ 0.0 _ENDIF_;
_aNTotTHyp_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_) _THEN_ (_oNH4WHyp_+_oNO3WHyp_+_oNDetWHyp_+_oNDiatWHyp_+_oNGrenWHyp_+_oNBlueWHyp_ +_oNZooHyp_)*_sDepthWHyp_ _ELSE_ 0.0 _ENDIF_;
_aPTotTHyp_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_) _THEN_ (_oPO4WHyp_+_oPDetWHyp_+_oPDiatWHyp_+_oPGrenWHyp_+_oPBlueWHyp_ +_oPZooHyp_+_oPAIMWHyp_) * _sDepthWHyp_ _ELSE_ 0.0 _ENDIF_;
_aSiTotTHyp_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_) _THEN_ (_oSiO2WHyp_ + _oSiDetWHyp_ + _cSiDDiat_*_oDDiatWHyp_) *_sDepthWHyp_ _ELSE_ 0.0 _ENDIF_;
_aO2TotTHyp_ = _IF_ (_aInclStrat_ _EQ_ _TRUE_) _THEN_ (_oO2WHyp_ ) *_sDepthWHyp_ _ELSE_ 0.0 _ENDIF_;
_aDTotW_ = _aDTotTHyp_ +  (_oDIMWEpi_ + _oDDetWEpi_ + _oDDiatWEpi_ + _oDGrenWEpi_ + _oDBlueWEpi_ + _oDZooEpi_) * _sDepthWEpi_ + _aDFish_ + _sDPisc_ + _aDVeg_;
_aDTotWEpi_ = (_oDIMWEpi_ + _oDDetWEpi_ + _oDDiatWEpi_ + _oDGrenWEpi_ + _oDBlueWEpi_ + _oDZooEpi_) * _sDepthWEpi_ ;
_aDTotWHyp_ = _aDTotTHyp_ ;
_aNTotW_ = _aNTotTHyp_+ (_oNH4WEpi_+_oNO3WEpi_+_oNDetWEpi_+_oNDiatWEpi_+_oNGrenWEpi_+_oNBlueWEpi_ +_oNZooEpi_)*_sDepthWEpi_ + _aNFish_ + _aNVeg_;
_aDTotTS_ = _sDIMS_+_sDHumS_+_sDDetS_+_sDDiatS_+_sDGrenS_+_sDBlueS_+_sDBent_;
_aNTotTS_ = _sNH4S_+_sNO3S_+_sNDetS_+_sNHumS_+_sNDiatS_+_sNGrenS_+_sNBlueS_ +_sNBent_;
_aDTotT_ = _aDTotTHyp_ + (_oDIMWEpi_+_oDDetWEpi_+_oDDiatWEpi_+_oDGrenWEpi_+_oDBlueWEpi_+_oDZooEpi_) * _sDepthWEpi_ +_aDFish_+_sDPisc_+_aDVeg_ +_sDIMS_+_sDHumS_+_sDDetS_+_sDDiatS_+_sDGrenS_+_sDBlueS_+_sDBent_ + _aDTotM_ + _sDBlueSurf_;
_aNTotT_ = _aNTotTHyp_+ (_oNH4WEpi_+_oNO3WEpi_+_oNDetWEpi_+_oNDiatWEpi_+_oNGrenWEpi_+_oNBlueWEpi_ +_oNZooEpi_)*_sDepthWEpi_ +_aNFish_+_aNPisc_+_aNVeg_ +_sNH4S_+_sNO3S_+_sNDetS_+_sNHumS_+_sNDiatS_+_sNGrenS_+_sNBlueS_ +_sNBent_ + _aNTotM_ + _sNBlueSurf_;
_aPTotT_ = _aPTotTHyp_ + (_oPO4WEpi_+_oPDetWEpi_+_oPDiatWEpi_+_oPGrenWEpi_+_oPBlueWEpi_ +_oPZooEpi_+_oPAIMWEpi_) * _sDepthWEpi_ +_aPFish_+_aPPisc_+_aPVeg_ +_sPO4S_+_sPDetS_+_sPHumS_+_sPDiatS_+_sPGrenS_+_sPBlueS_ +_sPAIMS_+_sPBent_ + _aPTotM_ +_sPBlueSurf_;
_aSiTotT_ = _aSiTotTHyp_ + (_oSiO2WEpi_ + _oSiDetWEpi_ + _cSiDDiat_*_oDDiatWEpi_) *_sDepthWEpi_ + _sSiDetS_ + _cSiDDiat_*_sDDiatS_ + _aSiTotM_;
_aO2TotT_ = _aO2TotTHyp_ + ( _oO2WEpi_) *_sDepthWEpi_ + _aO2TotM_;
_tDBedTotW_ = _tDBedVeg_ ;
_tNBedTotW_  = (_wNBedNH4WHyp_ + _wNBedNO3WHyp_ + _wNBedDetWHyp_) * _sDepthWHyp_ + (_wNBedNH4WEpi_ + _wNBedNO3WEpi_ + _wNBedDetWEpi_) * _sDepthWEpi_ + _tNBedVeg_ ;
_tDBedTotS_ =  _tDBedDetSEpi_ + _tDBedDetSHyp_;
_tNBedTotS_ = _tNBedNH4S_ + _tNBedNO3S_ + _tNBedDetS_;
...
_aDErrorW_ = _aDTotW_ - _sDExtTotW_;
_aDErrorWEpi_ = _aDTotWEpi_ - _sDExtTotWEpi_;
_aDErrorWHyp_ = _aDTotWHyp_ - _sDExtTotWHyp_;
_aNErrorW_ = _aNTotW_ - _sNExtTotW_;
_aDErrorS_ = _aDTotTS_ - _sDExtTotS_;
_aNErrorS_ = _aNTotTS_ - _sNExtTotS_;
