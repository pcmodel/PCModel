_uDepthMix0_ =_IF_ ( _calcMixDepth_ _EQ_ _TRUE_ ) _THEN_ _cAMix_ * _POW_ ( _cFetch_ , (_cBMix_) ) _ELSE_ _cDepthMix_ _ENDIF_;
_aInclStrat0_ =_IF_ ( _InclStrat_ _EQ_ _FALSE_ _OR_ _uDepthMix0_ _GT_ _cDepthW0_ - _cMinDepthHypEpi_ ) _THEN_ 0.0 _ELSE_ 1.0 _ENDIF_;
_sDepthWHyp0_ = _IF_ ( _InclStrat_ _EQ_ _FALSE_) _THEN_ _NearZero_ _ELSEIF_ (_InitDepth_ _EQ_ _TRUE_ _AND_ (_uDepthMix0_ _LE_ _cDepthW0_ -_cMinDepthHypEpi_ ) ) _THEN_ _cDepthW0_ - _uDepthMix0_ _ELSEIF_ (_InitDepth_ _EQ_ _TRUE_ _AND_ ( _uDepthMix0_ _GT_ _cDepthW0_ - _cMinDepthHypEpi_ )) _THEN_ _NearZero_ _ELSE_ _cDepthWHyp0_ _ENDIF_;
_MassHyp0_ = _IF_ _CalcMass_ _EQ_ _TRUE_ _THEN_ _sDepthWHyp0_ _ELSE_ 1.0 _ENDIF_;
...
_sDPisc0_ = _cDPisc0_;
_sDepthWEpi0_ = _IF_ ( _aInclStrat0_ _EQ_ _FALSE_) _THEN_ _cDepthW0_ _ELSEIF_ (_InitDepth_ _EQ_ _TRUE_ _AND_ ( _uDepthMix0_ _LE_ _cDepthW0_ - _cMinDepthHypEpi_)) _THEN_ _uDepthMix0_ _ELSEIF_ (_InitDepth_ _EQ_ _TRUE_ _AND_( _uDepthMix0_ _GT_ _cDepthW0_ - _cMinDepthHypEpi_ )) _THEN_ _cDepthW0_ _ELSE_ _cDepthWEpi0_ _ENDIF_;
_MassEpi0_ = _IF_ _CalcMass_ _EQ_ _TRUE_ _THEN_ _sDepthWEpi0_ _ELSE_ 1.0 _ENDIF_;
...
_uO2TotTHyp0_ = _IF_ (_aInclStrat0_ _EQ_ _TRUE_) _THEN_ (_sO2WHyp0_ ) *_sDepthWHyp0_ / _MassHyp0_ _ELSE_ 0.0 _ENDIF_;
_uDTotTHyp0_ = _IF_ (_aInclStrat0_ _EQ_ _TRUE_) _THEN_ (_sDIMWHyp0_ + _sDDetWHyp0_ + _uDPhytWHyp0_ + _sDZooHyp0_) * _sDepthWHyp0_ / _MassHyp0_ _ELSE_ 0.0 _ENDIF_;
_uPTotTHyp0_ = _IF_ (_aInclStrat0_ _EQ_ _TRUE_) _THEN_ (_sPO4WHyp0_ + _sPDetWHyp0_ + _sPAIMWHyp0_ + _uPPhytWHyp0_ + _sPZooHyp0_) * _sDepthWHyp0_ / _MassHyp0_ _ELSE_ 0.0 _ENDIF_;
_uNTotTHyp0_ = _IF_ (_aInclStrat0_ _EQ_ _TRUE_) _THEN_ (_sNH4WHyp0_ + _sNO3WHyp0_ + _sNDetWHyp0_ + _uNPhytWHyp0_ + _sNZooHyp0_) * _sDepthWHyp0_ / _MassHyp0_ _ELSE_ 0.0 _ENDIF_ ;
_uSiTotTHyp0_ = _IF_ (_aInclStrat0_ _EQ_ _TRUE_) _THEN_ (_sSiO2WHyp0_ + _sSiDetWHyp0_ + _cSiDDiat_ * _sDDiatWHyp0_) * _sDepthWHyp0_ / _MassHyp0_ _ELSE_ 0.0 _ENDIF_;
...
_uO2TotT0_ = _uO2TotTHyp0_ + ( _sO2WEpi0_) *_sDepthWEpi0_ / _MassEpi0_ + _uO2TotM0_;
_uDTotW0_ = _uDTotTHyp0_ + _sDIMWEpi0_ + _sDDetWEpi0_ + _sDDiatWEpi0_ + _sDGrenWEpi0_ + _sDBlueWEpi0_ + _sDZooEpi0_ + _uDVeg0_ + _uDFish0_ + _sDPisc0_;
_uDTotWEpi0_ = _sDIMWEpi0_ + _sDDetWEpi0_ + _sDDiatWEpi0_ + _sDGrenWEpi0_ + _sDBlueWEpi0_ + _sDZooEpi0_;
_uDTotWHyp0_ = _uDTotTHyp0_;
_uNTotW0_ = _uNTotTHyp0_ + _sNH4WEpi0_+_sNO3WEpi0_+_sNDetWEpi0_+_sNDiatWEpi0_+_sNGrenWEpi0_+_sNBlueWEpi0_ +_sNZooEpi0_ +_uNVeg0_ + _uNFish0_;
_uDTotS0_ = _sDIMS0_ + _sDHumS0_ + _sDDetS0_ + _sDDiatS0_ + _sDGrenS0_ + _sDBlueS0_ + _sDBent0_;
_uNTotS0_ = _sNH4S0_+_sNO3S0_+_sNDetS0_+_sNHumS0_+_sNDiatS0_+_sNGrenS0_+_sNBlueS0_ +_sNBent0_;
_uDTotT0_ = _uDTotTHyp0_ + (_sDIMWEpi0_ + _sDDetWEpi0_ + _uDPhytWEpi0_ + _sDZooEpi0_) * _sDepthWEpi0_ / _MassEpi0_ + _uDVeg0_ + _sDIMS0_ + _sDHumS0_ + _sDDetS0_ + _uDPhytS0_ + _uDFish0_ + _sDPisc0_ + _sDBent0_ + _uDTotM0_ + _sDBlueSurf0_;
_uPTotT0_ = _uPTotTHyp0_ + (_sPO4WEpi0_ + _sPDetWEpi0_ + _sPAIMWEpi0_ + _uPPhytWEpi0_ + _sPZooEpi0_) * _sDepthWEpi0_ / _MassEpi0_+ _uPVeg0_ + _sPO4S0_ + _sPDetS0_ + _sPAIMS0_ + _sPHumS0_ + _uPPhytS0_ + _uPFish0_ + _uPPisc0_ + _sPBent0_ + _uPTotM0_ + _sPBlueSurf0_;
_uNTotT0_ = _uNTotTHyp0_ + (_sNH4WEpi0_ + _sNO3WEpi0_ + _sNDetWEpi0_ + _uNPhytWEpi0_ + _sNZooEpi0_) * _sDepthWEpi0_ / _MassEpi0_ + _uNVeg0_ + _sNH4S0_ + _sNO3S0_ + _sNDetS0_ + _uNPhytS0_ + _sNHumS0_ + _uNFish0_ + _uNPisc0_ + _sNBent0_ + _uNTotM0_ +_sNBlueSurf0_;
_uSiTotT0_ = _uSiTotTHyp0_+ (_sSiO2WEpi0_ + _sSiDetWEpi0_ + _cSiDDiat_ * _sDDiatWEpi0_) * _sDepthWEpi0_ / _MassEpi0_ + _sSiDetS0_ + _cSiDDiat_*_sDDiatS0_ + _uSiTotM0_;
_sDExtTotW0_ = _uDTotW0_;
_sDExtTotWEpi0_ = _uDTotWEpi0_;
_sDExtTotWHyp0_ = _uDTotWHyp0_;
_sNExtTotW0_ = _uNTotW0_;
_sDExtTotS0_ = _uDTotS0_;
_sNExtTotS0_ = _uNTotS0_;
