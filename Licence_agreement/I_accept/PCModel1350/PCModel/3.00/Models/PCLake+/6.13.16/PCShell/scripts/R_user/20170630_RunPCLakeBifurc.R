...
# -----------------------------------------------------------------------------------------------------------------------------------------------------------------------
dir_HOME			=	"C:/PClakeDitch/"							# location of the PCModel1350 folder
dir_DATM			=	paste(dir_HOME,"PCModel1350/PCModel/3.00/Models/PCLake/6.13.16/",sep='')						# location of DATM implementation (excel)
dir_SCHIL           =	dir_DATM		# location of PCShell
file_DATM			=	"PL613162_NAP_20170619.xls"															# file name of the DATM implementation
work_case           =	"R_base_work_case_Naardermeer"                      								# name of work case
